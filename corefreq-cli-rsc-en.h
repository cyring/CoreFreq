...
#define RSC_LAYOUT_RULLER_VOLTAGE_COND0_CODE_EN 			\
...
#define RSC_LAYOUT_RULLER_VOLTAGE_COND1_CODE_EN 			\
	"--- Freq(MHz) - VID - Vcore -- TMP --------- Accumulator ---"	\
	"---- Power(W) ----------------------------------------------"	\
	"------------------------------------------------------------"	\
	"------------------------------------------------------------"	\
...
#define RSC_LAYOUT_RULLER_POWER_CODE_EN				\
...
#define RSC_HELP_MOVE_WINDOW_CODE_EN	"      Move window "
...
#define RSC_ADV_HELP_ITEM_1_CODE_EN	" Frequency view:                      "
#define RSC_ADV_HELP_ITEM_2_CODE_EN	" %         Averages | Package C-States"
#define RSC_ADV_HELP_ITEM_3_CODE_EN	" Task Monitoring view:                "
#define RSC_ADV_HELP_ITEM_4_CODE_EN	" b                Sorting tasks order "
#define RSC_ADV_HELP_ITEM_5_CODE_EN	" n               Select task tracking "
