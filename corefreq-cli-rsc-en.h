...
#define RSC_LAYOUT_PACKAGE_FABRIC_PERF_CODE_EN				\
	...
	#define RSC_LAYOUT_PACKAGE_FABRIC_CODE_EN			\
		RSC_LAYOUT_PACKAGE_FABRIC_PMC_CODE_EN(AMD_ZEN_PMC)

	#define RSC_LAYOUT_PACKAGE_CTR0_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(0, AMD_ZEN_PMC)
	#define RSC_LAYOUT_PACKAGE_CTR1_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(1, AMD_ZEN_PMC)
	#define RSC_LAYOUT_PACKAGE_CTR2_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(2, AMD_ZEN_PMC)
	#define RSC_LAYOUT_PACKAGE_CTR3_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(3, AMD_ZEN_PMC)
	#define RSC_LAYOUT_PACKAGE_CTR4_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(4, AMD_ZEN_PMC)
	#define RSC_LAYOUT_PACKAGE_CTR5_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(5, AMD_ZEN_PMC)
	#define RSC_LAYOUT_PACKAGE_CTR6_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(6, AMD_ZEN_PMC)
	#define RSC_LAYOUT_PACKAGE_CTR7_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(7, AMD_ZEN_PMC)
#else
	#define RSC_LAYOUT_PACKAGE_FABRIC_CODE_EN			\
		RSC_LAYOUT_PACKAGE_FABRIC_UMC_CODE_EN

	#define RSC_LAYOUT_PACKAGE_CTR0_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(0, UMC)
	#define RSC_LAYOUT_PACKAGE_CTR1_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(1, UMC)
	#define RSC_LAYOUT_PACKAGE_CTR2_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(2, UMC)
	#define RSC_LAYOUT_PACKAGE_CTR3_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(3, UMC)
	#define RSC_LAYOUT_PACKAGE_CTR4_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(4, UMC)
	#define RSC_LAYOUT_PACKAGE_CTR5_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(5, UMC)
	#define RSC_LAYOUT_PACKAGE_CTR6_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(6, UMC)
	#define RSC_LAYOUT_PACKAGE_CTR7_CODE_EN 			\
		RSC_LAYOUT_PACKAGE_CTR_PMC_CODE_EN(7, UMC)
#endif
