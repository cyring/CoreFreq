...
void PCI_Intel(SHM_STRUCT *Shm, PROC_RO *Proc, CORE_RO *Core,unsigned short DID)
{
	...
	case PCI_DEVICE_ID_INTEL_KABYLAKE_Y_IMC_HQ:
		SKL_CAP(Shm, Proc, Core);
		SKL_IMC(Shm, Proc);
		SET_CHIPSET(IC_UNIONPOINT);
		break;
	...
	case PCI_DEVICE_ID_INTEL_WHISKEYLAKE_U_IMC_HAQ: /* WHL Quad Core */
		...
		SET_CHIPSET(IC_CANNONPOINT);
		break;
	case PCI_DEVICE_ID_INTEL_COMETLAKE_S_IMC_6C:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_S_IMC_10C:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_H_IMC_10C:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_W_IMC_10C:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_M_IMC_6C:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_U_IMC_HB:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_U1_IMC:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_U3_IMC:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_S1_IMC:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_S2_IMC:
	case PCI_DEVICE_ID_INTEL_COMETLAKE_S5_IMC:
		SKL_CAP(Shm, Proc, Core);
		SKL_IMC(Shm, Proc);
		break;
	...
	case PCI_DEVICE_ID_INTEL_COMETLAKE_W480_PCH:
		SET_CHIPSET(IC_W480);
		break;
	case PCI_DEVICE_ID_INTEL_ICELAKE_U_IMC:
	case PCI_DEVICE_ID_INTEL_ICELAKE_U_4C:
		SKL_CAP(Shm, Proc, Core);
		SKL_IMC(Shm, Proc);
		break;
	case PCI_DEVICE_ID_INTEL_TIGERLAKE_U1_IMC:
	case PCI_DEVICE_ID_INTEL_TIGERLAKE_U2_IMC:
	case PCI_DEVICE_ID_INTEL_TIGERLAKE_U3_IMC:
	case PCI_DEVICE_ID_INTEL_TIGERLAKE_U4_IMC:
	case PCI_DEVICE_ID_INTEL_TIGERLAKE_H_IMC:
	...
	case PCI_DEVICE_ID_INTEL_ROCKETLAKE_W580_PCH:
		SET_CHIPSET(IC_W580);
		break;
	case PCI_DEVICE_ID_INTEL_ALDERLAKE_1_IMC:
	case PCI_DEVICE_ID_INTEL_ALDERLAKE_2_IMC:
		RKL_CAP(Shm, Proc, Core);
		RKL_IMC(Shm, Proc);
		break;
	}
