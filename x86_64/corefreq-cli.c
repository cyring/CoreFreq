				...
				unsigned int *cellPadding )
{
	...
	[13] = {RSC(SYS_REG_HDR_HWCR_512).CODE(), RSC(SYS_REG_HWCR_512).CODE()},
	[14] = {RSC(SYS_REG_HDR_HWCR_ID).CODE() , RSC(SYS_REG_HWCR_ID).CODE()},
	[15] = {RSC(SYS_REGS_SPACE).CODE(),		NULL},
	[16] = {RSC(SYS_REGS_SPACE).CODE(),		NULL},
		{NULL, NULL}
	},
	...
	[13] =	{DO_HWCR, fAMD	, HWCR_512	, 1	},
	[14] =	{DO_HWCR, fAMD	, HWCR_ID	, 1	},
	[15] =	{DO_SPC , 1	, UNDEF_CR	, 0	},
	[16] =	{DO_SPC , 1	, UNDEF_CR	, 0	},
		{DO_END , 1	, UNDEF_CR	, 0	}
	}
