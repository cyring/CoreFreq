				...
				unsigned int *cellPadding )
{
	...
	[ 4] =	{RSC(SYS_REG_HDR_DF).CODE(),	RSC(SYS_REG_FLAGS_DF).CODE()},
	[ 5] =	{RSC(SYS_REG_HDR_OF).CODE(),	RSC(SYS_REG_FLAGS_OF).CODE()},
	[ 6] =	{RSC(SYS_REG_HDR_IOPL).CODE(),	RSC(SYS_REG_FLAGS_IOPL).CODE()},
	[ 7] =	{RSC(SYS_REG_HDR_NT).CODE(),	RSC(SYS_REG_FLAGS_NT).CODE()},
	[ 8] =	{RSC(SYS_REG_HDR_RF).CODE(),	RSC(SYS_REG_FLAGS_RF).CODE()},
	[ 9] =	{RSC(SYS_REG_HDR_VM).CODE(),	RSC(SYS_REG_FLAGS_VM).CODE()},
	[10] =	{RSC(SYS_REG_HDR_AC).CODE(),	RSC(SYS_REG_FLAGS_AC).CODE()},
	[11] =	{RSC(SYS_REG_HDR_VIF).CODE(),	RSC(SYS_REG_FLAGS_VIF).CODE()},
	[12] =	{RSC(SYS_REG_HDR_VIP).CODE(),	RSC(SYS_REG_FLAGS_VIP).CODE()},
	[13] =	{RSC(SYS_REG_HDR_ID).CODE(),	RSC(SYS_REG_FLAGS_ID).CODE()},
	...
	[ 4] =	{DO_FLAG, 1	, RFLAG_DF	, 1	},
	[ 5] =	{DO_FLAG, 1	, RFLAG_OF	, 1	},
	[ 6] =	{DO_FLAG, 1	, RFLAG_IOPL	, 2	},
	[ 7] =	{DO_FLAG, 1	, RFLAG_NT	, 1	},
	[ 8] =	{DO_FLAG, 1	, RFLAG_RF	, 1	},
	[ 9] =	{DO_FLAG, 1	, RFLAG_VM	, 1	},
	[10] =	{DO_FLAG, 1	, RFLAG_AC	, 1	},
	[11] =	{DO_FLAG, 1	, RFLAG_VIF	, 1	},
	[12] =	{DO_FLAG, 1	, RFLAG_VIP	, 1	},
	[13] =	{DO_FLAG, 1	, RFLAG_ID	, 1	},
