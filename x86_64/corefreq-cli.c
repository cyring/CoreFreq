...
/* Row Mark */
	{
		...
		{ 0, RO(Shm)->Proc.Features.ExtFeature_Leaf1_EAX.AVX512_BF16 },
		(unsigned short[])
		{ RO(Shm)->Proc.Features.ExtFeature_Leaf1_EAX.AVX512_BF16 },
	},
	{
		NULL,
		RSC(ISA_AVX_VEX).CODE(), NULL,
		{ 0, RO(Shm)->Proc.Features.ExtFeature_Leaf1_EAX.AVX_VNNI_VEX },
		(unsigned short[])
...
/* LOCATOR Channel 1 */
		{.pString = RO(Shm)->SMB.Memory.Locator[ 4],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[ 5],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[ 6],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[ 7],	.secret = 0},
/* LOCATOR Channel 2 */
		{.pString = RO(Shm)->SMB.Memory.Locator[ 8],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[ 9],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[10],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[11],	.secret = 0},
/* LOCATOR Channel 3 */
		{.pString = RO(Shm)->SMB.Memory.Locator[12],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[13],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[14],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[15],	.secret = 0},
/* LOCATOR Channel 4 */
		{.pString = RO(Shm)->SMB.Memory.Locator[16],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[17],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[18],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[19],	.secret = 0},
/* LOCATOR Channel 5 */
		{.pString = RO(Shm)->SMB.Memory.Locator[20],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[21],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[22],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[23],	.secret = 0},
/* LOCATOR Channel 6 */
		{.pString = RO(Shm)->SMB.Memory.Locator[24],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[25],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[26],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[27],	.secret = 0},
/* LOCATOR Channel 7 */
		{.pString = RO(Shm)->SMB.Memory.Locator[28],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[29],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[30],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[31],	.secret = 0},
/* LOCATOR Channel 8 */
		{.pString = RO(Shm)->SMB.Memory.Locator[32],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[33],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[34],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[35],	.secret = 0},
/* LOCATOR Channel 9 */
		{.pString = RO(Shm)->SMB.Memory.Locator[36],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[37],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[38],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[39],	.secret = 0},
/* LOCATOR Channel 10 */
		{.pString = RO(Shm)->SMB.Memory.Locator[40],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[41],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[42],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[43],	.secret = 0},
/* LOCATOR Channel 11 */
		{.pString = RO(Shm)->SMB.Memory.Locator[44],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[45],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[46],	.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Locator[47],	.secret = 0},
/* MANUFACTURER Channel 0 */
...
/* MANUFACTURER Channel 1 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[ 4],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[ 5],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[ 6],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[ 7],.secret = 0},
/* MANUFACTURER Channel 2 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[ 8],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[ 9],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[10],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[11],.secret = 0},
/* MANUFACTURER Channel 3 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[12],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[13],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[14],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[15],.secret = 0},
/* MANUFACTURER Channel 4 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[16],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[17],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[18],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[19],.secret = 0},
/* MANUFACTURER Channel 5 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[20],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[21],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[22],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[23],.secret = 0},
/* MANUFACTURER Channel 6 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[24],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[25],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[26],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[27],.secret = 0},
/* MANUFACTURER Channel 7 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[28],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[29],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[30],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[31],.secret = 0},
/* MANUFACTURER Channel 8 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[32],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[33],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[34],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[35],.secret = 0},
/* MANUFACTURER Channel 9 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[36],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[37],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[38],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[39],.secret = 0},
/* MANUFACTURER Channel 10 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[40],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[41],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[42],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[43],.secret = 0},
/* MANUFACTURER Channel 11 */
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[44],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[45],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[46],.secret = 0},
		{.pString = RO(Shm)->SMB.Memory.Manufacturer[47],.secret = 0},
/* PARTNUMBER Channel 0 */
...
/* PARTNUMBER Channel 1 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[ 4], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[ 5], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[ 6], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[ 7], .secret = 0},
/* PARTNUMBER Channel 2 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[ 8], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[ 9], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[10], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[11], .secret = 0},
/* PARTNUMBER Channel 3 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[12], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[13], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[14], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[15], .secret = 0},
/* PARTNUMBER Channel 4 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[16], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[17], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[18], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[19], .secret = 0},
/* PARTNUMBER Channel 5 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[20], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[21], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[22], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[23], .secret = 0},
/* PARTNUMBER Channel 6 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[24], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[25], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[26], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[27], .secret = 0},
/* PARTNUMBER Channel 7 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[28], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[29], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[30], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[31], .secret = 0},
/* PARTNUMBER Channel 8 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[32], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[33], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[34], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[35], .secret = 0},
/* PARTNUMBER Channel 9 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[36], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[37], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[38], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[39], .secret = 0},
/* PARTNUMBER Channel 10 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[40], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[41], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[42], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[43], .secret = 0},
/* PARTNUMBER Channel 11 */
		{.pString = RO(Shm)->SMB.Memory.PartNumber[44], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[45], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[46], .secret = 0},
		{.pString = RO(Shm)->SMB.Memory.PartNumber[47], .secret = 0}
	};
...
/* LOCATOR Channel 0 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_00_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_01_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_02_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_03_LOC)		" ",
/* LOCATOR Channel 1 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_04_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_05_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_06_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_07_LOC)		" ",
/* LOCATOR Channel 2 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_08_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_09_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_10_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_11_LOC)		" ",
/* LOCATOR Channel 3 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_12_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_13_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_14_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_15_LOC)		" ",
/* LOCATOR Channel 4 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_16_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_17_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_18_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_19_LOC)		" ",
/* LOCATOR Channel 5 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_20_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_21_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_22_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_23_LOC)		" ",
/* LOCATOR Channel 6 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_24_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_25_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_26_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_27_LOC)		" ",
/* LOCATOR Channel 7 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_28_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_29_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_30_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_31_LOC)		" ",
/* LOCATOR Channel 8 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_32_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_33_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_34_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_35_LOC)		" ",
/* LOCATOR Channel 9 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_36_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_37_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_38_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_39_LOC)		" ",
/* LOCATOR Channel 10 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_40_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_41_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_42_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_43_LOC)		" ",
/* LOCATOR Channel 11 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_44_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_45_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_46_LOC)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_47_LOC)		" ",
/* MANUFACTURER Channel 0 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_00_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_01_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_02_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_03_MFR)		" ",
/* MANUFACTURER Channel 1 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_04_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_05_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_06_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_07_MFR)		" ",
/* MANUFACTURER Channel 2 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_08_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_09_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_10_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_11_MFR)		" ",
/* MANUFACTURER Channel 3 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_12_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_13_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_14_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_15_MFR)		" ",
/* MANUFACTURER Channel 4 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_16_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_17_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_18_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_19_MFR)		" ",
/* MANUFACTURER Channel 5 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_20_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_21_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_22_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_23_MFR)		" ",
/* MANUFACTURER Channel 6 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_24_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_25_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_26_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_27_MFR)		" ",
/* MANUFACTURER Channel 7 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_28_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_29_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_30_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_31_MFR)		" ",
/* MANUFACTURER Channel 8 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_32_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_33_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_34_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_35_MFR)		" ",
/* MANUFACTURER Channel 9 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_36_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_37_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_38_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_39_MFR)		" ",
/* MANUFACTURER Channel 10 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_40_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_41_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_42_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_43_MFR)		" ",
/* MANUFACTURER Channel 11 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_44_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_45_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_46_MFR)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_47_MFR)		" ",
/* PARTNUMBER Channel 0 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_00_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_01_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_02_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_03_PN)		" ",
/* PARTNUMBER Channel 1 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_04_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_05_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_06_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_07_PN)		" ",
/* PARTNUMBER Channel 2 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_08_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_09_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_10_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_11_PN)		" ",
/* PARTNUMBER Channel 3 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_12_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_13_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_14_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_15_PN)		" ",
/* PARTNUMBER Channel 4 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_16_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_17_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_18_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_19_PN)		" ",
/* PARTNUMBER Channel 5 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_20_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_21_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_22_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_23_PN)		" ",
/* PARTNUMBER Channel 6 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_24_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_25_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_26_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_27_PN)		" ",
/* PARTNUMBER Channel 7 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_28_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_29_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_30_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_31_PN)		" ",
/* PARTNUMBER Channel 8 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_32_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_33_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_34_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_35_PN)		" ",
/* PARTNUMBER Channel 9 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_36_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_37_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_38_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_39_PN)		" ",
/* PARTNUMBER Channel 10 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_40_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_41_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_42_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_43_PN)		" ",
/* PARTNUMBER Channel 11 */
	" "	COREFREQ_STRINGIFY(SMB_MEM_44_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_45_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_46_PN)		" ",
	" "	COREFREQ_STRINGIFY(SMB_MEM_47_PN)		" "
};
  ...
  if ((str != NULL) && (chipStr != NULL))
  {
	...
	for (cha = 0; cha < RO(Shm)->Uncore.MC[mc].ChannelCount; cha++)
	{
	  ...
	  for (slot = 0; slot < RO(Shm)->Uncore.MC[mc].SlotCount; slot++)
	  {
		...
		(RO(Shm)->Uncore.MC[mc].SlotCount > 1? slot:cha) % SMB_MAX_DIMM;
