...
/* ASCII */
	...
	LDT(RSC_BOOST_CTRL_HWP_COMM),
	LDT(RSC_BOOST_CTRL_CPPC_COMM),
	LDT(RSC_PERFORMANCE),
	LDT(RSC_TARGET),
	LDT(RSC_LEVEL),
	...
	LDQ(RSC_SYS_REG_HDR_MXCS),
	LDQ(RSC_SYS_REG_HDR_MXCS_IE),
	LDQ(RSC_SYS_REG_HDR_MXCS_DE),
	LDQ(RSC_SYS_REG_HDR_MXCS_ZE),
	LDQ(RSC_SYS_REG_HDR_MXCS_OE),
	LDQ(RSC_SYS_REG_HDR_MXCS_UE),
	LDQ(RSC_SYS_REG_HDR_MXCS_PE),
	LDQ(RSC_SYS_REG_HDR_MXCS_DAZ),
	LDQ(RSC_SYS_REG_HDR_MXCS_IM),
	LDQ(RSC_SYS_REG_HDR_MXCS_DM),
	LDQ(RSC_SYS_REG_HDR_MXCS_ZM),
	LDQ(RSC_SYS_REG_HDR_MXCS_OM),
	LDQ(RSC_SYS_REG_HDR_MXCS_UM),
	LDQ(RSC_SYS_REG_HDR_MXCS_PM),
	LDQ(RSC_SYS_REG_HDR_MXCS_RC),
	LDQ(RSC_SYS_REG_HDR_MXCS_FZ),
	LDQ(RSC_SYS_REG_HDR_MXCS_MM),
	LDT(RSC_SYS_REGS_MXCS),
	LDT(RSC_SYS_REG_MXCS_IE),
	LDT(RSC_SYS_REG_MXCS_DE),
	LDT(RSC_SYS_REG_MXCS_ZE),
	LDT(RSC_SYS_REG_MXCS_OE),
	LDT(RSC_SYS_REG_MXCS_UE),
	LDT(RSC_SYS_REG_MXCS_PE),
	LDT(RSC_SYS_REG_MXCS_DAZ),
	LDT(RSC_SYS_REG_MXCS_IM),
	LDT(RSC_SYS_REG_MXCS_DM),
	LDT(RSC_SYS_REG_MXCS_ZM),
	LDT(RSC_SYS_REG_MXCS_OM),
	LDT(RSC_SYS_REG_MXCS_UM),
	LDT(RSC_SYS_REG_MXCS_PM),
	LDT(RSC_SYS_REG_MXCS_RC),
	LDT(RSC_SYS_REG_MXCS_FZ),
	LDT(RSC_SYS_REG_MXCS_MM),
	...
	LDQ(RSC_SYS_REG_HDR_XSS),
	LDQ(RSC_SYS_REG_HDR_XSS_PT),
	LDQ(RSC_SYS_REG_HDR_XSS_PASID),
	LDQ(RSC_SYS_REG_HDR_XSS_CEU),
	LDQ(RSC_SYS_REG_HDR_XSS_CES),
	LDQ(RSC_SYS_REG_HDR_XSS_HDC),
	LDQ(RSC_SYS_REG_HDR_XSS_UINTR),
	LDQ(RSC_SYS_REG_HDR_XSS_LBR),
	LDQ(RSC_SYS_REG_HDR_XSS_HWP),
	LDT(RSC_SYS_REGS_XSS),
	LDT(RSC_SYS_REG_XSS_PT),
	LDT(RSC_SYS_REG_XSS_PASID),
	LDT(RSC_SYS_REG_XSS_CEU),
	LDT(RSC_SYS_REG_XSS_CES),
	LDT(RSC_SYS_REG_XSS_HDC),
	LDT(RSC_SYS_REG_XSS_UINTR),
	LDT(RSC_SYS_REG_XSS_LBR),
	LDT(RSC_SYS_REG_XSS_HWP),
	...
	LDQ(RSC_ISA_AMX_COMPLEX),
	LDT(RSC_ISA_AMX_COMPLEX_COMM),
	LDQ(RSC_ISA_APX_F),
	LDT(RSC_ISA_APX_F_COMM),
	LDQ(RSC_ISA_APX_NDD_NF),
	LDT(RSC_ISA_APX_NDD_NF_COMM),
	LDQ(RSC_ISA_AVX),
	...
	LDQ(RSC_ISA_AVX10),
	LDQ(RSC_ISA_AVX10_128),
	LDQ(RSC_ISA_AVX10_256),
	LDQ(RSC_ISA_AVX10_512),
	LDQ(RSC_ISA_AVX_VEX),
	LDQ(RSC_ISA_AVX_INT8),
	LDQ(RSC_ISA_AVX_INT16),
	...
	LDQ(RSC_ISA_MOVRS),
	LDT(RSC_ISA_MOVRS_COMM),
	LDQ(RSC_ISA_MSRLIST),
	LDT(RSC_ISA_MSRLIST_COMM),
	...
	LDT(RSC_PERF_MON_MONITORLESS_MWAIT),
