...
#define RSC_LAYOUT_RULLER_VOLTAGE_COND0_CODE_FR 			\
...
#define RSC_LAYOUT_RULLER_VOLTAGE_COND1_CODE_FR 			\
	"--- Freq(MHz) - VID - Vcore -- TMP -------- Accumulateur ---"	\
	" Puissance(W) ----------------------------------------------"	\
	"------------------------------------------------------------"	\
	"------------------------------------------------------------"	\
...
#define RSC_LAYOUT_RULLER_POWER_CODE_FR				\
	"-- $ Package:   .     -- Cores:   .     -- Uncore:   .     -"	\
	" Memoire:   .     ------------------------------------------"	\
	"------------------------------------------------------------"	\
	"------------------------------------------------------------"	\
	"------------------------------------------------------------"	\
...
#define RSC_PRESENT_CODE_FR		"Present"
...
#define RSC_HELP_MOVE_WINDOW_CODE_FR	" Deplacer fenetre "
...
#define RSC_ADV_HELP_ITEM_1_CODE_FR	" Vue Frequence:                       "
#define RSC_ADV_HELP_ITEM_2_CODE_FR	" %           Moyennes | Etats-Package "
#define RSC_ADV_HELP_ITEM_3_CODE_FR	" Vue Suivi des taches:                "
#define RSC_ADV_HELP_ITEM_4_CODE_FR	" b          Critere de tri des taches "
#define RSC_ADV_HELP_ITEM_5_CODE_FR	" n          Choisir la tache a suivre "
