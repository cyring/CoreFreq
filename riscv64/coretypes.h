...
#define	PMU_COUNTER_OVERFLOW	0x3fffffffLLU
...
typedef struct	/* BSP features.					*/
{
	...
	struct {
		Bit64
			/* misa single-letter Source: riscv_isa[] bitmap*/
			ISA_A		:  1-0,  /* Atomics(Zaamo+Zalrsc)*/
			ISA_C		:  2-1,  /* Compressed		*/
			ISA_D		:  3-2,  /* Double-precision FP */
			ISA_F		:  4-3,  /* Single-precision FP */
			ISA_H		:  5-4,  /* Hypervisor		*/
			ISA_I		:  6-5,  /* RV64I Base Integer	*/
			ISA_M		:  7-6,  /* Multiply/Divide	*/
			ISA_Q		:  8-7,  /* Quad-precision FP	*/
			ISA_V		:  9-8,  /* Vector		*/
			/* Za - Atomics sub-extensions			*/
			Zaamo		: 10-9,
			Zabha		: 11-10,
			Zacas		: 12-11,
			Zalasr		: 13-12,
			...
			Zclsd		: 27-26,
			Zcmop		: 28-27,
			/* Zf - Floating-Point extensions		*/
			Zfa		: 29-28,
			Zfbfmin		: 30-29,
			Zfh		: 31-30,
			Zfhmin		: 32-31,
			/* Zi - Cache/CSR/Hint extensions		*/
			Zicbom		: 33-32,
			Zicbop		: 34-33,
			Zicboz		: 35-34,
			Ziccrse 	: 36-35,
			Zicfilp 	: 37-36,  /* CFI landing pads	*/
			Zicfiss 	: 38-37,  /* CFI shadow stack	*/
			Zicntr		: 39-38,
			Zicond		: 40-39,
			Zicsr		: 41-40,
			Zifencei	: 42-41,
			...
			Zimop		: 46-45,
			Zilsd		: 47-46,
			/* Zk - Cryptography Scalar extensions		*/
			Zk		: 48-47,
			Zkn		: 49-48,
			Zknd		: 50-49,
			Zkne		: 51-50,
			...
			Zksh		: 56-55,
			Zkt		: 57-56,
			/* Zt - Memory Ordering extension		*/
			Ztso		: 58-57,
			_Unused1_	: 64-58;

		/*		Vector extensions			*/
		Bit64
			/* Zve - Vector sub-profiles			*/
			Zve32f		:  1-0,
			Zve32x		:  2-1,
			Zve64d		:  3-2,
			Zve64f		:  4-3,
			Zve64x		:  5-4,
			/* Zvf - Vector Floating-Point extension	*/
			Zvfbfmin	:  6-5,
			Zvfbfwma	:  7-6,
			Zvfh		:  8-7,
			Zvfhmin		:  9-8,
			/* Zvk - Cryptography Vector extensions 	*/
			Zvbb		: 10-9,
			Zvbc		: 11-10,
			Zvkb		: 12-11,
			Zvkg		: 13-12,
			...
			Zvksh		: 24-23,
			Zvkt		: 25-24,
			/* Ss, Sm, Sv - Privileged S/M extensions	*/
			Smaia		: 26-25,
			Smmpm		: 27-26,
			Smnpm		: 28-27,
			Smstateen	: 29-28,
			...
			Svnapot 	: 37-36,
			Svpbmt		: 38-37,
			/* XThead - SpacemiT X60 vendor extensions	*/
			Xtheadba	: 39-38,
			Xtheadbb	: 40-39,
			Xtheadbs	: 41-40,
			Xtheadcmo	: 42-41,
