...
/*ASM_COUNTERx1(x28, x29, ASM_RDTSC, mem_tsc, __VA_ARGS__)*/

#define RDTSC_COUNTERx2(mem_tsc, ...) \
/*ASM_COUNTERx2(x28, x29, x30, ASM_RDTSC, mem_tsc, __VA_ARGS__)*/

#define RDTSC_COUNTERx3(mem_tsc, ...) \
/*ASM_COUNTERx3(x28, x29, x30, x31, ASM_RDTSC, mem_tsc, __VA_ARGS__)*/
