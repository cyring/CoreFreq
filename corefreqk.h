...
typedef struct
{
	...
	long			(*OverClock)(CLOCK_ARG *pOverClock);
	char			*Architecture;
...
extern long Intel_Turbo_Config8C(CLOCK_ARG *pOverClock) ;
extern long OverClock_IvyBridge_EP(CLOCK_ARG *pOverClock) ;
extern long OverClock_Haswell_EP(CLOCK_ARG *pOverClock) ;
extern long OverClock_Skylake_X(CLOCK_ARG *pOverClock) ;
...
/* 29*/	{
	...
	.Timer = InitTimer_SandyBridge_EP,
	.BaseClock = BaseClock_IvyBridge,
	.OverClock = OverClock_IvyBridge_EP,
...
/* 31*/	{
	...
	.BaseClock = BaseClock_Haswell,
	.OverClock = OverClock_Haswell_EP,
