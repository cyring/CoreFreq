...
#define COREFREQ_VERSION	"1.25.5"
...
#define COREFREQ_IOCTL_CC6	_IO(COREFREQ_IOCTL_MAGIC, 0xb)
#define COREFREQ_IOCTL_PC6	_IO(COREFREQ_IOCTL_MAGIC, 0xc)
#define COREFREQ_IOCTL_PKGCST	_IO(COREFREQ_IOCTL_MAGIC, 0xd)
#define COREFREQ_IOCTL_IOMWAIT	_IO(COREFREQ_IOCTL_MAGIC, 0xe)
#define COREFREQ_IOCTL_IORCST	_IO(COREFREQ_IOCTL_MAGIC, 0xf)
#define COREFREQ_IOCTL_ODCM	_IO(COREFREQ_IOCTL_MAGIC, 0x10)
#define COREFREQ_IOCTL_ODCM_DC	_IO(COREFREQ_IOCTL_MAGIC, 0x11)
#define COREFREQ_IOCTL_CPU_OFF	_IO(COREFREQ_IOCTL_MAGIC, 0x12)
#define COREFREQ_IOCTL_CPU_ON	_IO(COREFREQ_IOCTL_MAGIC, 0x13)
