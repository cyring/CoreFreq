...
enum EVENT_ENUM {
	/*	MSR_IA32_{PACKAGE}_THERM_STATUS:	x11		*/
	LSHIFT_THERMAL_STS,
	LSHIFT_THERMAL_LOG,
	LSHIFT_PROCHOT_STS,
	LSHIFT_PROCHOT_LOG,
	...
	LSHIFT_CROSS_DOMAIN,
	/*	MSR_SKL_CORE_PERF_LIMIT_REASONS:	x22		*/
	LSHIFT_CORE_THM_STS,
	LSHIFT_CORE_HOT_STS,
	LSHIFT_CORE_HOT_LOG,
	LSHIFT_CORE_THM_LOG,
	...
	LSHIFT_CORE_EDP_STS,
	LSHIFT_CORE_EDP_LOG,
	LSHIFT_CORE_TURBO_STS,
	LSHIFT_CORE_TURBO_LOG,
/*TODO
	LSHIFT_CORE_ATTEN_STS,
	LSHIFT_CORE_ATTEN_LOG,
*/
	/*	MSR_GRAPHICS_PERF_LIMIT_REASONS:	x16		*/
	LSHIFT_GFX_THM_STS,
	LSHIFT_GFX_HOT_STS,
	LSHIFT_GFX_HOT_LOG,
	LSHIFT_GFX_THM_LOG,
	...
	LSHIFT_GFX_EDP_STS,
	LSHIFT_GFX_EDP_LOG,
	/*	MSR_RING_PERF_LIMIT_REASONS:		x16		*/
	LSHIFT_RING_THM_STS,
	LSHIFT_RING_HOT_STS,
	LSHIFT_RING_HOT_LOG,
	LSHIFT_RING_THM_LOG,
...
enum THERM_PWR_EVENTS {
	...
	EVENT_CORE_TURBO_STS	= 0x1LLU << LSHIFT_CORE_TURBO_STS,
	EVENT_CORE_TURBO_LOG	= 0x1LLU << LSHIFT_CORE_TURBO_LOG,
/*TODO
	EVENT_CORE_ATTEN_STS	= 0x1LLU << LSHIFT_CORE_ATTEN_STS,
	EVENT_CORE_ATTEN_LOG	= 0x1LLU << LSHIFT_CORE_ATTEN_LOG,
*/
...
#define ALL_EVENT_MASK (EVENT_THERMAL_STS	\
		...
		|	EVENT_CORE_PL2_LOG	\
		|	EVENT_CORE_EDP_LOG	\
		|	EVENT_CORE_TURBO_STS	\
		|	EVENT_CORE_TURBO_LOG	\
/*TODO		|	EVENT_CORE_ATTEN_STS	\
		|	EVENT_CORE_ATTEN_LOG*/	\
		|	EVENT_GFX_THM_STS	\
		|	EVENT_GFX_HOT_STS	\
		|	EVENT_GFX_HOT_LOG	\
		|	EVENT_GFX_THM_LOG	\
...
VOLTAGE_FORMULA_INTEL_TGL  =(VOLTAGE_KIND_INTEL_SNB << 8)  | FORMULA_SCOPE_CORE,
VOLTAGE_FORMULA_INTEL_ADL  =(VOLTAGE_KIND_INTEL_SNB << 8)  | FORMULA_SCOPE_CORE,
