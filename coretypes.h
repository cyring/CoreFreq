...
enum THERMAL_FORMULAS {
	...
	(0b000000000000000000000001 << 8) | FORMULA_SCOPE_SMT,
	THERMAL_FORMULA_AMD =						\
	(0b000000000001000000000000 << 8) | FORMULA_SCOPE_SMT,
	THERMAL_FORMULA_AMD_0Fh =					\
	(0b000000000011000000000000 << 8) | FORMULA_SCOPE_SMT,
	THERMAL_FORMULA_AMD_15h =					\
	(0b000001000001000000000000 << 8) | FORMULA_SCOPE_PKG,
	THERMAL_FORMULA_AMD_17h =					\
	(0b000100000001000000000000 << 8) | FORMULA_SCOPE_PKG
};
...
enum VOLTAGE_FORMULAS {
	...
	(0b000000000000000000000011 << 8) | FORMULA_SCOPE_SMT,
	VOLTAGE_FORMULA_INTEL_SNB =					\
	(0b000000000000000010000001 << 8) | FORMULA_SCOPE_PKG,
	VOLTAGE_FORMULA_INTEL_SKL_X =					\
	(0b000000000000010000000001 << 8) | FORMULA_SCOPE_SMT,
	VOLTAGE_FORMULA_AMD =						\
	(0b000000000001000000000000 << 8) | FORMULA_SCOPE_SMT,
	VOLTAGE_FORMULA_AMD_0Fh =					\
	(0b000000000011000000000000 << 8) | FORMULA_SCOPE_SMT,
	VOLTAGE_FORMULA_AMD_15h =					\
	(0b000001000001000000000000 << 8) | FORMULA_SCOPE_SMT,
...
enum POWER_FORMULAS {
	...
	(0b000000000000000000000000 << 8) | FORMULA_SCOPE_NONE,
	POWER_FORMULA_INTEL =						\
	(0b000000000000000000000001 << 8) | FORMULA_SCOPE_PKG,
	POWER_FORMULA_INTEL_ATOM =					\
	(0b000000000000000000000011 << 8) | FORMULA_SCOPE_PKG,
	POWER_FORMULA_AMD =						\
	(0b000000000001000000000000 << 8) | FORMULA_SCOPE_PKG,
