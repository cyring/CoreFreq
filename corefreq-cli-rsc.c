...
ASCII	RSC_MEM_CTRL_UNIT_MHZ_CODE_EQ[] = RSC_MEM_CTRL_UNIT_MHZ_CODE,
	RSC_MEM_CTRL_UNIT_MTS_CODE_EQ[] = RSC_MEM_CTRL_UNIT_MTS_CODE,
	RSC_MEM_CTRL_UNIT_MBS_CODE_EQ[] = RSC_MEM_CTRL_UNIT_MBS_CODE,
	RSC_MEM_CTRL_BLANK_CODE_EQ[]	= RSC_MEM_CTRL_BLANK_CODE;
...
ASCII	RSC_CREATE_HELP_BLANK_CODE_EQ[] = RSC_CREATE_HELP_BLANK_CODE;
...
ASCII	Rsc_CreateAdvHelp_Blank_Code[] = RSC_CREATE_ADV_HELP_BLANK_CODE;
...
ASCII	RSC_BOX_BLANK_DESC_CODE_EQ[] = RSC_BOX_BLANK_DESC_CODE;

ASCII	RSC_BOX_INTERVAL_STEP1_CODE_EQ[] = RSC_BOX_INTERVAL_STEP1_CODE,
	RSC_BOX_INTERVAL_STEP2_CODE_EQ[] = RSC_BOX_INTERVAL_STEP2_CODE,
	RSC_BOX_INTERVAL_STEP3_CODE_EQ[] = RSC_BOX_INTERVAL_STEP3_CODE,
	RSC_BOX_INTERVAL_STEP4_CODE_EQ[] = RSC_BOX_INTERVAL_STEP4_CODE,
	RSC_BOX_INTERVAL_STEP5_CODE_EQ[] = RSC_BOX_INTERVAL_STEP5_CODE,
	RSC_BOX_INTERVAL_STEP6_CODE_EQ[] = RSC_BOX_INTERVAL_STEP6_CODE,
	RSC_BOX_INTERVAL_STEP7_CODE_EQ[] = RSC_BOX_INTERVAL_STEP7_CODE,
	RSC_BOX_INTERVAL_STEP8_CODE_EQ[] = RSC_BOX_INTERVAL_STEP8_CODE,
	RSC_BOX_INTERVAL_STEP9_CODE_EQ[] = RSC_BOX_INTERVAL_STEP9_CODE,
	RSC_BOX_INTERVAL_STEP10_CODE_EQ[]= RSC_BOX_INTERVAL_STEP10_CODE;

ASCII	RSC_BOX_DCU_L1_TITLE_CODE_EQ[]   = RSC_BOX_DCU_L1_TITLE_CODE,
	RSC_BOX_DCU_L1_IP_TITLE_CODE_EQ[]= RSC_BOX_DCU_L1_IP_TITLE_CODE,
	RSC_BOX_DCU_L2_TITLE_CODE_EQ[]   = RSC_BOX_DCU_L2_TITLE_CODE,
	RSC_BOX_DCU_L2_CL_TITLE_CODE_EQ[]= RSC_BOX_DCU_L2_CL_TITLE_CODE;

ASCII	RSC_BOX_EIST_TITLE_CODE_EQ[] = RSC_BOX_EIST_TITLE_CODE;

ASCII	RSC_BOX_C1E_TITLE_CODE_EQ[] = RSC_BOX_C1E_TITLE_CODE;

ASCII	RSC_BOX_TURBO_TITLE_CODE_EQ[] = RSC_BOX_TURBO_TITLE_CODE;

ASCII	RSC_BOX_C1A_TITLE_CODE_EQ[] = RSC_BOX_C1A_TITLE_CODE,
	RSC_BOX_C3A_TITLE_CODE_EQ[] = RSC_BOX_C3A_TITLE_CODE,
	RSC_BOX_C1U_TITLE_CODE_EQ[] = RSC_BOX_C1U_TITLE_CODE,
	RSC_BOX_C2U_TITLE_CODE_EQ[] = RSC_BOX_C2U_TITLE_CODE,
	RSC_BOX_C3U_TITLE_CODE_EQ[] = RSC_BOX_C3U_TITLE_CODE;

ASCII	RSC_BOX_CC6_TITLE_CODE_EQ[] = RSC_BOX_CC6_TITLE_CODE,
	RSC_BOX_C6D_TITLE_CODE_EQ[] = RSC_BOX_C6D_TITLE_CODE;

ASCII	RSC_BOX_MC6_TITLE_CODE_EQ[] = RSC_BOX_MC6_TITLE_CODE,
	RSC_BOX_PC6_TITLE_CODE_EQ[] = RSC_BOX_PC6_TITLE_CODE;

ASCII	RSC_BOX_STATE_C8_CODE_EQ[] =RSC_BOX_STATE_C8_CODE,
	RSC_BOX_STATE_C7_CODE_EQ[] =RSC_BOX_STATE_C7_CODE,
	RSC_BOX_STATE_C6_CODE_EQ[] =RSC_BOX_STATE_C6_CODE,
	RSC_BOX_STATE_C4_CODE_EQ[] =RSC_BOX_STATE_C4_CODE,
	RSC_BOX_STATE_C3_CODE_EQ[] =RSC_BOX_STATE_C3_CODE;

ASCII	RSC_BOX_PKG_STATE_LIMIT_C10_CODE_EQ[]= RSC_BOX_PKG_STATE_LIMIT_C10_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C9_CODE_EQ[] = RSC_BOX_PKG_STATE_LIMIT_C9_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C8_CODE_EQ[] = RSC_BOX_PKG_STATE_LIMIT_C8_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C7S_CODE_EQ[]= RSC_BOX_PKG_STATE_LIMIT_C7S_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C7_CODE_EQ[] = RSC_BOX_PKG_STATE_LIMIT_C7_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C6R_CODE_EQ[]= RSC_BOX_PKG_STATE_LIMIT_C6R_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C6_CODE_EQ[] = RSC_BOX_PKG_STATE_LIMIT_C6_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C4_CODE_EQ[] = RSC_BOX_PKG_STATE_LIMIT_C4_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C3_CODE_EQ[] = RSC_BOX_PKG_STATE_LIMIT_C3_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C2_CODE_EQ[] = RSC_BOX_PKG_STATE_LIMIT_C2_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C1_CODE_EQ[] = RSC_BOX_PKG_STATE_LIMIT_C1_CODE,
	RSC_BOX_PKG_STATE_LIMIT_C0_CODE_EQ[] = RSC_BOX_PKG_STATE_LIMIT_C0_CODE;

ASCII	RSC_BOX_DUTY_CYCLE_PCT1_CODE_EQ[]=RSC_BOX_DUTY_CYCLE_PCT1_CODE,
	RSC_BOX_DUTY_CYCLE_PCT2_CODE_EQ[]=RSC_BOX_DUTY_CYCLE_PCT2_CODE,
	RSC_BOX_DUTY_CYCLE_PCT3_CODE_EQ[]=RSC_BOX_DUTY_CYCLE_PCT3_CODE,
	RSC_BOX_DUTY_CYCLE_PCT4_CODE_EQ[]=RSC_BOX_DUTY_CYCLE_PCT4_CODE,
	RSC_BOX_DUTY_CYCLE_PCT5_CODE_EQ[]=RSC_BOX_DUTY_CYCLE_PCT5_CODE,
	RSC_BOX_DUTY_CYCLE_PCT6_CODE_EQ[]=RSC_BOX_DUTY_CYCLE_PCT6_CODE,
	RSC_BOX_DUTY_CYCLE_PCT7_CODE_EQ[]=RSC_BOX_DUTY_CYCLE_PCT7_CODE,
	RSC_BOX_EXT_DUTY_CYCLE_PCT1_CODE_EQ[]=RSC_BOX_EXT_DUTY_CYCLE_PCT1_CODE,
	RSC_BOX_EXT_DUTY_CYCLE_PCT2_CODE_EQ[]=RSC_BOX_EXT_DUTY_CYCLE_PCT2_CODE,
	RSC_BOX_EXT_DUTY_CYCLE_PCT3_CODE_EQ[]=RSC_BOX_EXT_DUTY_CYCLE_PCT3_CODE,
	RSC_BOX_EXT_DUTY_CYCLE_PCT4_CODE_EQ[]=RSC_BOX_EXT_DUTY_CYCLE_PCT4_CODE,
	RSC_BOX_EXT_DUTY_CYCLE_PCT5_CODE_EQ[]=RSC_BOX_EXT_DUTY_CYCLE_PCT5_CODE,
	RSC_BOX_EXT_DUTY_CYCLE_PCT6_CODE_EQ[]=RSC_BOX_EXT_DUTY_CYCLE_PCT6_CODE,
	RSC_BOX_EXT_DUTY_CYCLE_PCT7_CODE_EQ[]=RSC_BOX_EXT_DUTY_CYCLE_PCT7_CODE,
	RSC_BOX_EXT_DUTY_CYCLE_PCT8_CODE_EQ[]=RSC_BOX_EXT_DUTY_CYCLE_PCT8_CODE,
	RSC_BOX_EXT_DUTY_CYCLE_PCT9_CODE_EQ[]=RSC_BOX_EXT_DUTY_CYCLE_PCT9_CODE,
      RSC_BOX_EXT_DUTY_CYCLE_PCT10_CODE_EQ[]= RSC_BOX_EXT_DUTY_CYCLE_PCT10_CODE,
      RSC_BOX_EXT_DUTY_CYCLE_PCT11_CODE_EQ[]= RSC_BOX_EXT_DUTY_CYCLE_PCT11_CODE,
      RSC_BOX_EXT_DUTY_CYCLE_PCT12_CODE_EQ[]= RSC_BOX_EXT_DUTY_CYCLE_PCT12_CODE,
      RSC_BOX_EXT_DUTY_CYCLE_PCT13_CODE_EQ[]= RSC_BOX_EXT_DUTY_CYCLE_PCT13_CODE,
      RSC_BOX_EXT_DUTY_CYCLE_PCT14_CODE_EQ[]= RSC_BOX_EXT_DUTY_CYCLE_PCT14_CODE;

ASCII	RSC_BOX_POWER_POLICY_1_CODE_EQ[] = RSC_BOX_POWER_POLICY_1_CODE,
	RSC_BOX_POWER_POLICY_2_CODE_EQ[] = RSC_BOX_POWER_POLICY_2_CODE,
	RSC_BOX_POWER_POLICY_3_CODE_EQ[] = RSC_BOX_POWER_POLICY_3_CODE,
	RSC_BOX_POWER_POLICY_4_CODE_EQ[] = RSC_BOX_POWER_POLICY_4_CODE,
	RSC_BOX_POWER_POLICY_5_CODE_EQ[] = RSC_BOX_POWER_POLICY_5_CODE,
	RSC_BOX_POWER_POLICY_6_CODE_EQ[] = RSC_BOX_POWER_POLICY_6_CODE,
	RSC_BOX_POWER_POLICY_7_CODE_EQ[] = RSC_BOX_POWER_POLICY_7_CODE,
	RSC_BOX_POWER_POLICY_8_CODE_EQ[] = RSC_BOX_POWER_POLICY_8_CODE,
	RSC_BOX_POWER_POLICY_9_CODE_EQ[] = RSC_BOX_POWER_POLICY_9_CODE,
	RSC_BOX_POWER_POLICY_10_CODE_EQ[] = RSC_BOX_POWER_POLICY_10_CODE,
	RSC_BOX_POWER_POLICY_11_CODE_EQ[] = RSC_BOX_POWER_POLICY_11_CODE,
	RSC_BOX_POWER_POLICY_12_CODE_EQ[] = RSC_BOX_POWER_POLICY_12_CODE,
	RSC_BOX_POWER_POLICY_13_CODE_EQ[] = RSC_BOX_POWER_POLICY_13_CODE,
	RSC_BOX_POWER_POLICY_14_CODE_EQ[] = RSC_BOX_POWER_POLICY_14_CODE;


ASCII	RSC_BOX_HWP_TITLE_CODE_EQ[]	= RSC_BOX_HWP_TITLE_CODE,
	RSC_BOX_HDC_TITLE_CODE_EQ[]	= RSC_BOX_HDC_TITLE_CODE,
	RSC_BOX_R2H_TITLE_CODE_EQ[]	= RSC_BOX_R2H_TITLE_CODE;

ASCII	RSC_BOX_TDP_TITLE_CODE_EQ[]	= RSC_BOX_TDP_TITLE_CODE,
	RSC_BOX_TDP_BLANK_CODE_EQ[]	= RSC_BOX_TDP_BLANK_CODE;
...
ASCII	RSC_SYS_REGS_SPACE_CODE_EQ[]	= RSC_SYS_REGS_SPACE_CODE_EN,
	RSC_SYS_REGS_NA_CODE_EQ[]	= RSC_SYS_REGS_NA_CODE_EN,
	RSC_SYS_REGS_HDR_CPU_CODE_EQ[]	= RSC_SYS_REGS_HDR_CPU_CODE_EN,
...
ASCII	RSC_ISA_3DNOW_CODE_EQ[] 	= RSC_ISA_3DNOW_CODE,
	RSC_ISA_3DNOW_COMM_CODE_EQ[]	= RSC_ISA_3DNOW_COMM_CODE_EN,
	RSC_ISA_ADX_CODE_EQ[]		= RSC_ISA_ADX_CODE,
	RSC_ISA_ADX_COMM_CODE_EQ[]	= RSC_ISA_ADX_COMM_CODE_EN,
	RSC_ISA_AES_CODE_EQ[]		= RSC_ISA_AES_CODE,
	RSC_ISA_AES_COMM_CODE_EQ[]	= RSC_ISA_AES_COMM_CODE_EN,
	RSC_ISA_AVX_CODE_EQ[]		= RSC_ISA_AVX_CODE,
	RSC_ISA_AVX_COMM_CODE_EQ[]	= RSC_ISA_AVX_COMM_CODE_EN,
	RSC_ISA_AVX512_F_CODE_EQ[]	= RSC_ISA_AVX512_F_CODE,
	RSC_ISA_AVX512_DQ_CODE_EQ[]	= RSC_ISA_AVX512_DQ_CODE,
	RSC_ISA_AVX512_IFMA_CODE_EQ[]	= RSC_ISA_AVX512_IFMA_CODE,
	RSC_ISA_AVX512_PF_CODE_EQ[]	= RSC_ISA_AVX512_PF_CODE,
	RSC_ISA_AVX512_ER_CODE_EQ[]	= RSC_ISA_AVX512_ER_CODE,
	RSC_ISA_AVX512_CD_CODE_EQ[]	= RSC_ISA_AVX512_CD_CODE,
	RSC_ISA_AVX512_BW_CODE_EQ[]	= RSC_ISA_AVX512_BW_CODE,
	RSC_ISA_AVX512_VL_CODE_EQ[]	= RSC_ISA_AVX512_VL_CODE,
	RSC_ISA_AVX512_VBMI_CODE_EQ[]	= RSC_ISA_AVX512_VBMI_CODE,
	RSC_ISA_AVX512_VBMI2_CODE_EQ[]	= RSC_ISA_AVX512_VBMI2_CODE,
	RSC_ISA_AVX512_VNMI_CODE_EQ[]	= RSC_ISA_AVX512_VNMI_CODE,
	RSC_ISA_AVX512_ALG_CODE_EQ[]	= RSC_ISA_AVX512_ALG_CODE,
	RSC_ISA_AVX512_VPOP_CODE_EQ[]	= RSC_ISA_AVX512_VPOP_CODE,
	RSC_ISA_AVX512_VNNIW_CODE_EQ[]	= RSC_ISA_AVX512_VNNIW_CODE,
	RSC_ISA_AVX512_FMAPS_CODE_EQ[]	= RSC_ISA_AVX512_FMAPS_CODE,
	RSC_ISA_AVX512_VP2I_CODE_EQ[]	= RSC_ISA_AVX512_VP2I_CODE,
	RSC_ISA_AVX512_BF16_CODE_EQ[]	= RSC_ISA_AVX512_BF16_CODE,
	RSC_ISA_BMI_CODE_EQ[]		= RSC_ISA_BMI_CODE,
	RSC_ISA_BMI_COMM_CODE_EQ[]	= RSC_ISA_BMI_COMM_CODE_EN,
	RSC_ISA_CLWB_CODE_EQ[]		= RSC_ISA_CLWB_CODE,
	RSC_ISA_CLWB_COMM_CODE_EQ[]	= RSC_ISA_CLWB_COMM_CODE_EN,
	RSC_ISA_CLFLUSH_CODE_EQ[]	= RSC_ISA_CLFLUSH_CODE,
	RSC_ISA_CLFLUSH_COMM_CODE_EQ[]	= RSC_ISA_CLFLUSH_COMM_CODE_EN,
	RSC_ISA_AC_FLAG_CODE_EQ[]	= RSC_ISA_AC_FLAG_CODE,
	RSC_ISA_AC_FLAG_COMM_CODE_EQ[]	= RSC_ISA_AC_FLAG_COMM_CODE_EN,
	RSC_ISA_CMOV_CODE_EQ[]		= RSC_ISA_CMOV_CODE,
	RSC_ISA_CMOV_COMM_CODE_EQ[]	= RSC_ISA_CMOV_COMM_CODE_EN,
	RSC_ISA_XCHG8B_CODE_EQ[]	= RSC_ISA_XCHG8B_CODE,
	RSC_ISA_XCHG8B_COMM_CODE_EQ[]	= RSC_ISA_XCHG8B_COMM_CODE_EN,
	RSC_ISA_XCHG16B_CODE_EQ[]	= RSC_ISA_XCHG16B_CODE,
	RSC_ISA_XCHG16B_COMM_CODE_EQ[]	= RSC_ISA_XCHG16B_COMM_CODE_EN,
	RSC_ISA_F16C_CODE_EQ[]		= RSC_ISA_F16C_CODE,
	RSC_ISA_F16C_COMM_CODE_EQ[]	= RSC_ISA_F16C_COMM_CODE_EN,
	RSC_ISA_FPU_CODE_EQ[]		= RSC_ISA_FPU_CODE,
	RSC_ISA_FPU_COMM_CODE_EQ[]	= RSC_ISA_FPU_COMM_CODE_EN,
	RSC_ISA_FXSR_CODE_EQ[]		= RSC_ISA_FXSR_CODE,
	RSC_ISA_FXSR_COMM_CODE_EQ[]	= RSC_ISA_FXSR_COMM_CODE_EN,
	RSC_ISA_LSHF_CODE_EQ[]		= RSC_ISA_LSHF_CODE,
	RSC_ISA_LSHF_COMM_CODE_EQ[]	= RSC_ISA_LSHF_COMM_CODE_EN,
	RSC_ISA_MMX_CODE_EQ[]		= RSC_ISA_MMX_CODE,
	RSC_ISA_MMX_COMM_CODE_EQ[]	= RSC_ISA_MMX_COMM_CODE_EN,
	RSC_ISA_MWAITX_CODE_EQ[]	= RSC_ISA_MWAITX_CODE,
	RSC_ISA_MWAITX_COMM_CODE_EQ[]	= RSC_ISA_MWAITX_COMM_CODE_EN,
	RSC_ISA_MOVBE_CODE_EQ[] 	= RSC_ISA_MOVBE_CODE,
	RSC_ISA_MOVBE_COMM_CODE_EQ[]	= RSC_ISA_MOVBE_COMM_CODE_EN,
	RSC_ISA_PCLMULDQ_CODE_EQ[]	= RSC_ISA_PCLMULDQ_CODE,
	RSC_ISA_PCLMULDQ_COMM_CODE_EQ[]	= RSC_ISA_PCLMULDQ_COMM_CODE_EN,
	RSC_ISA_POPCNT_CODE_EQ[]	= RSC_ISA_POPCNT_CODE,
	RSC_ISA_POPCNT_COMM_CODE_EQ[]	= RSC_ISA_POPCNT_COMM_CODE_EN,
	RSC_ISA_RDRAND_CODE_EQ[]	= RSC_ISA_RDRAND_CODE,
	RSC_ISA_RDRAND_COMM_CODE_EQ[]	= RSC_ISA_RDRAND_COMM_CODE_EN,
	RSC_ISA_RDSEED_CODE_EQ[]	= RSC_ISA_RDSEED_CODE,
	RSC_ISA_RDSEED_COMM_CODE_EQ[]	= RSC_ISA_RDSEED_COMM_CODE_EN,
	RSC_ISA_RDTSCP_CODE_EQ[]	= RSC_ISA_RDTSCP_CODE,
	RSC_ISA_RDTSCP_COMM_CODE_EQ[]	= RSC_ISA_RDTSCP_COMM_CODE_EN,
	RSC_ISA_SEP_CODE_EQ[]		= RSC_ISA_SEP_CODE,
	RSC_ISA_SEP_COMM_CODE_EQ[]	= RSC_ISA_SEP_COMM_CODE_EN,
	RSC_ISA_SHA_CODE_EQ[]		= RSC_ISA_SHA_CODE,
	RSC_ISA_SHA_COMM_CODE_EQ[]	= RSC_ISA_SHA_COMM_CODE_EN,
	RSC_ISA_SSE_CODE_EQ[]		= RSC_ISA_SSE_CODE,
	RSC_ISA_SSE_COMM_CODE_EQ[]	= RSC_ISA_SSE_COMM_CODE_EN,
	RSC_ISA_SSE2_CODE_EQ[]		= RSC_ISA_SSE2_CODE,
	RSC_ISA_SSE2_COMM_CODE_EQ[]	= RSC_ISA_SSE2_COMM_CODE_EN,
	RSC_ISA_SSE3_CODE_EQ[]		= RSC_ISA_SSE3_CODE,
	RSC_ISA_SSE3_COMM_CODE_EQ[]	= RSC_ISA_SSE3_COMM_CODE_EN,
	RSC_ISA_SSSE3_CODE_EQ[] 	= RSC_ISA_SSSE3_CODE,
	RSC_ISA_SSSE3_COMM_CODE_EQ[]	= RSC_ISA_SSSE3_COMM_CODE_EN,
	RSC_ISA_SSE4_1_CODE_EQ[]	= RSC_ISA_SSE4_1_CODE,
	RSC_ISA_SSE4_1_COMM_CODE_EQ[]	= RSC_ISA_SSE4_1_COMM_CODE_EN,
	RSC_ISA_SSE4_2_CODE_EQ[]	= RSC_ISA_SSE4_2_CODE,
	RSC_ISA_SSE4_2_COMM_CODE_EQ[]	= RSC_ISA_SSE4_2_COMM_CODE_EN,
	RSC_ISA_SERIALIZE_CODE_EQ[]	= RSC_ISA_SERIALIZE_CODE,
	RSC_ISA_SERIALIZE_COMM_CODE_EQ[]= RSC_ISA_SERIALIZE_COMM_CODE_EN,
	RSC_ISA_SYSCALL_CODE_EQ[]	= RSC_ISA_SYSCALL_CODE,
	RSC_ISA_SYSCALL_COMM_CODE_EQ[]	= RSC_ISA_SYSCALL_COMM_CODE_EN,
	RSC_ISA_RDPID_FMT1_CODE_EQ[]	= RSC_ISA_RDPID_FMT1_CODE,
	RSC_ISA_RDPID_FMT2_CODE_EQ[]	= RSC_ISA_RDPID_FMT2_CODE,
	RSC_ISA_RDPID_COMM_CODE_EQ[]	= RSC_ISA_RDPID_COMM_CODE_EN,
	RSC_ISA_UMIP_CODE_EQ[]		= RSC_ISA_UMIP_CODE,
	RSC_ISA_UMIP_COMM_CODE_EQ[]	= RSC_ISA_UMIP_COMM_CODE_EN,
	RSC_ISA_SGX_CODE_EQ[]		= RSC_ISA_SGX_CODE,
	RSC_ISA_SGX_COMM_CODE_EQ[]	= RSC_ISA_SGX_COMM_CODE_EN;
...
/* ASCII */
	...
	[RSC_SYS_REGS_SPACE]	= LDQ(	RSC_SYS_REGS_SPACE_CODE_EQ),
	[RSC_SYS_REGS_NA]	= LDQ(	RSC_SYS_REGS_NA_CODE_EQ),
	...
	[RSC_ISA_3DNOW] 	= LDQ(	RSC_ISA_3DNOW_CODE_EQ),
	[RSC_ISA_3DNOW_COMM]	= LDQ(	RSC_ISA_3DNOW_COMM_CODE_EQ),
	[RSC_ISA_ADX]		= LDQ(	RSC_ISA_ADX_CODE_EQ),
	[RSC_ISA_ADX_COMM]	= LDQ(	RSC_ISA_ADX_COMM_CODE_EQ),
	[RSC_ISA_AES]		= LDQ(	RSC_ISA_AES_CODE_EQ),
	[RSC_ISA_AES_COMM]	= LDQ(	RSC_ISA_AES_COMM_CODE_EQ),
	[RSC_ISA_AVX]		= LDQ(	RSC_ISA_AVX_CODE_EQ),
	[RSC_ISA_AVX_COMM]	= LDQ(	RSC_ISA_AVX_COMM_CODE_EQ),
	[RSC_ISA_AVX512_F]	= LDQ(	RSC_ISA_AVX512_F_CODE_EQ),
	[RSC_ISA_AVX512_DQ]	= LDQ(	RSC_ISA_AVX512_DQ_CODE_EQ),
	[RSC_ISA_AVX512_IFMA]	= LDQ(	RSC_ISA_AVX512_IFMA_CODE_EQ),
	[RSC_ISA_AVX512_PF]	= LDQ(	RSC_ISA_AVX512_PF_CODE_EQ),
	[RSC_ISA_AVX512_ER]	= LDQ(	RSC_ISA_AVX512_ER_CODE_EQ),
	[RSC_ISA_AVX512_CD]	= LDQ(	RSC_ISA_AVX512_CD_CODE_EQ),
	[RSC_ISA_AVX512_BW]	= LDQ(	RSC_ISA_AVX512_BW_CODE_EQ),
	[RSC_ISA_AVX512_VL]	= LDQ(	RSC_ISA_AVX512_VL_CODE_EQ),
	[RSC_ISA_AVX512_VBMI]	= LDQ(	RSC_ISA_AVX512_VBMI_CODE_EQ),
	[RSC_ISA_AVX512_VBMI2]	= LDQ(	RSC_ISA_AVX512_VBMI2_CODE_EQ),
	[RSC_ISA_AVX512_VNMI]	= LDQ(	RSC_ISA_AVX512_VNMI_CODE_EQ),
	[RSC_ISA_AVX512_ALG]	= LDQ(	RSC_ISA_AVX512_ALG_CODE_EQ),
	[RSC_ISA_AVX512_VPOP]	= LDQ(	RSC_ISA_AVX512_VPOP_CODE_EQ),
	[RSC_ISA_AVX512_VNNIW]	= LDQ(	RSC_ISA_AVX512_VNNIW_CODE_EQ),
	[RSC_ISA_AVX512_FMAPS]	= LDQ(	RSC_ISA_AVX512_FMAPS_CODE_EQ),
	[RSC_ISA_AVX512_VP2I]	= LDQ(	RSC_ISA_AVX512_VP2I_CODE_EQ),
	[RSC_ISA_AVX512_BF16]	= LDQ(	RSC_ISA_AVX512_BF16_CODE_EQ),
	[RSC_ISA_BMI]		= LDQ(	RSC_ISA_BMI_CODE_EQ),
	[RSC_ISA_BMI_COMM]	= LDQ(	RSC_ISA_BMI_COMM_CODE_EQ),
	[RSC_ISA_CLWB]		= LDQ(	RSC_ISA_CLWB_CODE_EQ),
	[RSC_ISA_CLWB_COMM]	= LDQ(	RSC_ISA_CLWB_COMM_CODE_EQ),
	[RSC_ISA_CLFLUSH]	= LDQ(	RSC_ISA_CLFLUSH_CODE_EQ),
	[RSC_ISA_CLFLUSH_COMM]	= LDQ(	RSC_ISA_CLFLUSH_COMM_CODE_EQ),
	[RSC_ISA_AC_FLAG]	= LDQ(	RSC_ISA_AC_FLAG_CODE_EQ),
	[RSC_ISA_AC_FLAG_COMM]	= LDQ(	RSC_ISA_AC_FLAG_COMM_CODE_EQ),
	[RSC_ISA_CMOV]		= LDQ(	RSC_ISA_CMOV_CODE_EQ),
	[RSC_ISA_CMOV_COMM]	= LDQ(	RSC_ISA_CMOV_COMM_CODE_EQ),
	[RSC_ISA_XCHG8B]	= LDQ(	RSC_ISA_XCHG8B_CODE_EQ),
	[RSC_ISA_XCHG8B_COMM]	= LDQ(	RSC_ISA_XCHG8B_COMM_CODE_EQ),
	[RSC_ISA_XCHG16B]	= LDQ(	RSC_ISA_XCHG16B_CODE_EQ),
	[RSC_ISA_XCHG16B_COMM]	= LDQ(	RSC_ISA_XCHG16B_COMM_CODE_EQ),
	[RSC_ISA_F16C]		= LDQ(	RSC_ISA_F16C_CODE_EQ),
	[RSC_ISA_F16C_COMM]	= LDQ(	RSC_ISA_F16C_COMM_CODE_EQ),
	[RSC_ISA_FPU]		= LDQ(	RSC_ISA_FPU_CODE_EQ),
	[RSC_ISA_FPU_COMM]	= LDQ(	RSC_ISA_FPU_COMM_CODE_EQ),
	[RSC_ISA_FXSR]		= LDQ(	RSC_ISA_FXSR_CODE_EQ),
	[RSC_ISA_FXSR_COMM]	= LDQ(	RSC_ISA_FXSR_COMM_CODE_EQ),
	[RSC_ISA_LSHF]		= LDQ(	RSC_ISA_LSHF_CODE_EQ),
	[RSC_ISA_LSHF_COMM]	= LDQ(	RSC_ISA_LSHF_COMM_CODE_EQ),
	[RSC_ISA_MMX]		= LDQ(	RSC_ISA_MMX_CODE_EQ),
	[RSC_ISA_MMX_COMM]	= LDQ(	RSC_ISA_MMX_COMM_CODE_EQ),
	[RSC_ISA_MWAITX]	= LDQ(	RSC_ISA_MWAITX_CODE_EQ),
	[RSC_ISA_MWAITX_COMM]	= LDQ(	RSC_ISA_MWAITX_COMM_CODE_EQ),
	[RSC_ISA_MOVBE] 	= LDQ(	RSC_ISA_MOVBE_CODE_EQ),
	[RSC_ISA_MOVBE_COMM]	= LDQ(	RSC_ISA_MOVBE_COMM_CODE_EQ),
	[RSC_ISA_PCLMULDQ]	= LDQ(	RSC_ISA_PCLMULDQ_CODE_EQ),
	[RSC_ISA_PCLMULDQ_COMM] = LDQ(	RSC_ISA_PCLMULDQ_COMM_CODE_EQ),
	[RSC_ISA_POPCNT]	= LDQ(	RSC_ISA_POPCNT_CODE_EQ),
	[RSC_ISA_POPCNT_COMM]	= LDQ(	RSC_ISA_POPCNT_COMM_CODE_EQ),
	[RSC_ISA_RDRAND]	= LDQ(	RSC_ISA_RDRAND_CODE_EQ),
	[RSC_ISA_RDRAND_COMM]	= LDQ(	RSC_ISA_RDRAND_COMM_CODE_EQ),
	[RSC_ISA_RDSEED]	= LDQ(	RSC_ISA_RDSEED_CODE_EQ),
	[RSC_ISA_RDSEED_COMM]	= LDQ(	RSC_ISA_RDSEED_COMM_CODE_EQ),
	[RSC_ISA_RDTSCP]	= LDQ(	RSC_ISA_RDTSCP_CODE_EQ),
	[RSC_ISA_RDTSCP_COMM]	= LDQ(	RSC_ISA_RDTSCP_COMM_CODE_EQ),
	[RSC_ISA_SEP]		= LDQ(	RSC_ISA_SEP_CODE_EQ),
	[RSC_ISA_SEP_COMM]	= LDQ(	RSC_ISA_SEP_COMM_CODE_EQ),
	[RSC_ISA_SHA]		= LDQ(	RSC_ISA_SHA_CODE_EQ),
	[RSC_ISA_SHA_COMM]	= LDQ(	RSC_ISA_SHA_COMM_CODE_EQ),
	[RSC_ISA_SSE]		= LDQ(	RSC_ISA_SSE_CODE_EQ),
	[RSC_ISA_SSE_COMM]	= LDQ(	RSC_ISA_SSE_COMM_CODE_EQ),
	[RSC_ISA_SSE2]		= LDQ(	RSC_ISA_SSE2_CODE_EQ),
	[RSC_ISA_SSE2_COMM]	= LDQ(	RSC_ISA_SSE2_COMM_CODE_EQ),
	[RSC_ISA_SSE3]		= LDQ(	RSC_ISA_SSE3_CODE_EQ),
	[RSC_ISA_SSE3_COMM]	= LDQ(	RSC_ISA_SSE3_COMM_CODE_EQ),
	[RSC_ISA_SSSE3] 	= LDQ(	RSC_ISA_SSSE3_CODE_EQ),
	[RSC_ISA_SSSE3_COMM]	= LDQ(	RSC_ISA_SSSE3_COMM_CODE_EQ),
	[RSC_ISA_SSE4_1]	= LDQ(	RSC_ISA_SSE4_1_CODE_EQ),
	[RSC_ISA_SSE4_1_COMM]	= LDQ(	RSC_ISA_SSE4_1_COMM_CODE_EQ),
	[RSC_ISA_SSE4_2]	= LDQ(	RSC_ISA_SSE4_2_CODE_EQ),
	[RSC_ISA_SSE4_2_COMM]	= LDQ(	RSC_ISA_SSE4_2_COMM_CODE_EQ),
	[RSC_ISA_SERIALIZE]	= LDQ(	RSC_ISA_SERIALIZE_CODE_EQ),
	[RSC_ISA_SERIALIZE_COMM]= LDQ(	RSC_ISA_SERIALIZE_COMM_CODE_EQ),
	[RSC_ISA_SYSCALL]	= LDQ(	RSC_ISA_SYSCALL_CODE_EQ),
	[RSC_ISA_SYSCALL_COMM]	= LDQ(	RSC_ISA_SYSCALL_COMM_CODE_EQ),
	[RSC_ISA_RDPID_FMT1]	= LDQ(	RSC_ISA_RDPID_FMT1_CODE_EQ),
	[RSC_ISA_RDPID_FMT2]	= LDQ(	RSC_ISA_RDPID_FMT2_CODE_EQ),
	[RSC_ISA_RDPID_COMM]	= LDQ(	RSC_ISA_RDPID_COMM_CODE_EQ),
	[RSC_ISA_UMIP]		= LDQ(	RSC_ISA_UMIP_CODE_EQ),
	[RSC_ISA_UMIP_COMM]	= LDQ(	RSC_ISA_UMIP_COMM_CODE_EQ),
	[RSC_ISA_SGX]		= LDQ(	RSC_ISA_SGX_CODE_EQ),
	[RSC_ISA_SGX_COMM]	= LDQ(	RSC_ISA_SGX_COMM_CODE_EQ),
	...
	[RSC_MEM_CTRL_UNIT_MHZ] = LDQ(	RSC_MEM_CTRL_UNIT_MHZ_CODE_EQ),
	[RSC_MEM_CTRL_UNIT_MTS] = LDQ(	RSC_MEM_CTRL_UNIT_MTS_CODE_EQ),
	[RSC_MEM_CTRL_UNIT_MBS] = LDQ(	RSC_MEM_CTRL_UNIT_MBS_CODE_EQ),
	[RSC_MEM_CTRL_BLANK]	= LDQ(	RSC_MEM_CTRL_BLANK_CODE_EQ),
 ...
 [RSC_SETTINGS_GOVERNOR_REGISTERED]=LDT(RSC_SETTINGS_GOVERNOR_CPUFREQ_CODE_EN,
	...
	[RSC_HELP_BLANK]	= LDQ(	RSC_CREATE_HELP_BLANK_CODE_EQ),
	...
	[RSC_BOX_INTERVAL_STEP1] = LDQ( RSC_BOX_INTERVAL_STEP1_CODE_EQ),
	[RSC_BOX_INTERVAL_STEP2] = LDQ( RSC_BOX_INTERVAL_STEP2_CODE_EQ),
	[RSC_BOX_INTERVAL_STEP3] = LDQ( RSC_BOX_INTERVAL_STEP3_CODE_EQ),
	[RSC_BOX_INTERVAL_STEP4] = LDQ( RSC_BOX_INTERVAL_STEP4_CODE_EQ),
	[RSC_BOX_INTERVAL_STEP5] = LDQ( RSC_BOX_INTERVAL_STEP5_CODE_EQ),
	[RSC_BOX_INTERVAL_STEP6] = LDQ( RSC_BOX_INTERVAL_STEP6_CODE_EQ),
	[RSC_BOX_INTERVAL_STEP7] = LDQ( RSC_BOX_INTERVAL_STEP7_CODE_EQ),
	[RSC_BOX_INTERVAL_STEP8] = LDQ( RSC_BOX_INTERVAL_STEP8_CODE_EQ),
	[RSC_BOX_INTERVAL_STEP9] = LDQ( RSC_BOX_INTERVAL_STEP9_CODE_EQ),
	[RSC_BOX_INTERVAL_STEP10]= LDQ( RSC_BOX_INTERVAL_STEP10_CODE_EQ),
	...
	[RSC_BOX_DCU_L1_TITLE]	= LDQ(	RSC_BOX_DCU_L1_TITLE_CODE_EQ),
	[RSC_BOX_DCU_L1_IP_TITLE]=LDQ(	RSC_BOX_DCU_L1_IP_TITLE_CODE_EQ),
	[RSC_BOX_DCU_L2_TITLE]	= LDQ(	RSC_BOX_DCU_L2_TITLE_CODE_EQ),
	[RSC_BOX_DCU_L2_CL_TITLE]=LDQ(	RSC_BOX_DCU_L2_CL_TITLE_CODE_EQ),
	[RSC_BOX_EIST_TITLE]	= LDQ(	RSC_BOX_EIST_TITLE_CODE_EQ),
	[RSC_BOX_EIST_DESC]	= LDT(	RSC_BOX_EIST_DESC_CODE_EN,
					RSC_BOX_EIST_DESC_CODE_FR),
	[RSC_BOX_C1E_TITLE]	= LDQ(	RSC_BOX_C1E_TITLE_CODE_EQ),
	[RSC_BOX_C1E_DESC]	= LDT(	RSC_BOX_C1E_DESC_CODE_EN,
					RSC_BOX_C1E_DESC_CODE_FR),
	[RSC_BOX_TURBO_TITLE]	= LDQ(	RSC_BOX_TURBO_TITLE_CODE_EQ),
	[RSC_BOX_TURBO_DESC]	= LDT(	RSC_BOX_TURBO_DESC_CODE_EN,
					RSC_BOX_TURBO_DESC_CODE_FR),
	[RSC_BOX_C1A_TITLE]	= LDQ(	RSC_BOX_C1A_TITLE_CODE_EQ),
	[RSC_BOX_C1A_DESC]	= LDT(	RSC_BOX_C1A_DESC_CODE_EN,
					RSC_BOX_C1A_DESC_CODE_FR),
	[RSC_BOX_C3A_TITLE]	= LDQ(	RSC_BOX_C3A_TITLE_CODE_EQ),
	[RSC_BOX_C3A_DESC]	= LDT(	RSC_BOX_C3A_DESC_CODE_EN,
					RSC_BOX_C3A_DESC_CODE_FR),
	[RSC_BOX_C1U_TITLE]	= LDQ(	RSC_BOX_C1U_TITLE_CODE_EQ),
	[RSC_BOX_C1U_DESC]	= LDT(	RSC_BOX_C1U_DESC_CODE_EN,
					RSC_BOX_C1U_DESC_CODE_FR),
	[RSC_BOX_C2U_TITLE]	= LDQ(	RSC_BOX_C2U_TITLE_CODE_EQ),
	[RSC_BOX_C2U_DESC]	= LDT(	RSC_BOX_C2U_DESC_CODE_EN,
					RSC_BOX_C2U_DESC_CODE_FR),
	[RSC_BOX_C3U_TITLE]	= LDQ(	RSC_BOX_C3U_TITLE_CODE_EQ),
	...
	[RSC_BOX_STATE_C8]	= LDQ(	RSC_BOX_STATE_C8_CODE_EQ),
	[RSC_BOX_STATE_C7]	= LDQ(	RSC_BOX_STATE_C7_CODE_EQ),
	[RSC_BOX_STATE_C6]	= LDQ(	RSC_BOX_STATE_C6_CODE_EQ),
	[RSC_BOX_STATE_C4]	= LDQ(	RSC_BOX_STATE_C4_CODE_EQ),
	[RSC_BOX_STATE_C3]	= LDQ(	RSC_BOX_STATE_C3_CODE_EQ),
    [RSC_BOX_PKG_STATE_LIMIT_TITLE]=LDT(RSC_BOX_PKG_STATE_TITLE_CODE_EN,
					RSC_BOX_PKG_STATE_TITLE_CODE_FR),
      [RSC_BOX_PKG_STATE_LIMIT_C10]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C10_CODE_EQ),
       [RSC_BOX_PKG_STATE_LIMIT_C9]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C9_CODE_EQ),
       [RSC_BOX_PKG_STATE_LIMIT_C8]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C8_CODE_EQ),
      [RSC_BOX_PKG_STATE_LIMIT_C7S]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C7S_CODE_EQ),
       [RSC_BOX_PKG_STATE_LIMIT_C7]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C7_CODE_EQ),
      [RSC_BOX_PKG_STATE_LIMIT_C6R]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C6R_CODE_EQ),
       [RSC_BOX_PKG_STATE_LIMIT_C6]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C6_CODE_EQ),
       [RSC_BOX_PKG_STATE_LIMIT_C4]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C4_CODE_EQ),
       [RSC_BOX_PKG_STATE_LIMIT_C3]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C3_CODE_EQ),
       [RSC_BOX_PKG_STATE_LIMIT_C2]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C2_CODE_EQ),
       [RSC_BOX_PKG_STATE_LIMIT_C1]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C1_CODE_EQ),
       [RSC_BOX_PKG_STATE_LIMIT_C0]=LDQ(RSC_BOX_PKG_STATE_LIMIT_C0_CODE_EQ),
	...
	[RSC_BOX_DUTY_CYCLE_PCT1] = LDQ(RSC_BOX_DUTY_CYCLE_PCT1_CODE_EQ),
	[RSC_BOX_DUTY_CYCLE_PCT2] = LDQ(RSC_BOX_DUTY_CYCLE_PCT2_CODE_EQ),
	[RSC_BOX_DUTY_CYCLE_PCT3] = LDQ(RSC_BOX_DUTY_CYCLE_PCT3_CODE_EQ),
	[RSC_BOX_DUTY_CYCLE_PCT4] = LDQ(RSC_BOX_DUTY_CYCLE_PCT4_CODE_EQ),
	[RSC_BOX_DUTY_CYCLE_PCT5] = LDQ(RSC_BOX_DUTY_CYCLE_PCT5_CODE_EQ),
	[RSC_BOX_DUTY_CYCLE_PCT6] = LDQ(RSC_BOX_DUTY_CYCLE_PCT6_CODE_EQ),
	[RSC_BOX_DUTY_CYCLE_PCT7] = LDQ(RSC_BOX_DUTY_CYCLE_PCT7_CODE_EQ),
      [RSC_BOX_EXT_DUTY_CYCLE_PCT1]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT1_CODE_EQ),
      [RSC_BOX_EXT_DUTY_CYCLE_PCT2]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT2_CODE_EQ),
      [RSC_BOX_EXT_DUTY_CYCLE_PCT3]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT3_CODE_EQ),
      [RSC_BOX_EXT_DUTY_CYCLE_PCT4]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT4_CODE_EQ),
      [RSC_BOX_EXT_DUTY_CYCLE_PCT5]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT5_CODE_EQ),
      [RSC_BOX_EXT_DUTY_CYCLE_PCT6]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT6_CODE_EQ),
      [RSC_BOX_EXT_DUTY_CYCLE_PCT7]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT7_CODE_EQ),
      [RSC_BOX_EXT_DUTY_CYCLE_PCT8]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT8_CODE_EQ),
      [RSC_BOX_EXT_DUTY_CYCLE_PCT9]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT9_CODE_EQ),
     [RSC_BOX_EXT_DUTY_CYCLE_PCT10]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT10_CODE_EQ),
     [RSC_BOX_EXT_DUTY_CYCLE_PCT11]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT11_CODE_EQ),
     [RSC_BOX_EXT_DUTY_CYCLE_PCT12]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT12_CODE_EQ),
     [RSC_BOX_EXT_DUTY_CYCLE_PCT13]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT13_CODE_EQ),
     [RSC_BOX_EXT_DUTY_CYCLE_PCT14]=LDQ(RSC_BOX_EXT_DUTY_CYCLE_PCT14_CODE_EQ),
	...
	[RSC_BOX_POWER_POLICY_1] = LDQ( RSC_BOX_POWER_POLICY_1_CODE_EQ),
	[RSC_BOX_POWER_POLICY_2] = LDQ( RSC_BOX_POWER_POLICY_2_CODE_EQ),
	[RSC_BOX_POWER_POLICY_3] = LDQ( RSC_BOX_POWER_POLICY_3_CODE_EQ),
	[RSC_BOX_POWER_POLICY_4] = LDQ( RSC_BOX_POWER_POLICY_4_CODE_EQ),
	[RSC_BOX_POWER_POLICY_5] = LDQ( RSC_BOX_POWER_POLICY_5_CODE_EQ),
	[RSC_BOX_POWER_POLICY_6] = LDQ( RSC_BOX_POWER_POLICY_6_CODE_EQ),
	[RSC_BOX_POWER_POLICY_7] = LDQ( RSC_BOX_POWER_POLICY_7_CODE_EQ),
	[RSC_BOX_POWER_POLICY_8] = LDQ( RSC_BOX_POWER_POLICY_8_CODE_EQ),
	[RSC_BOX_POWER_POLICY_9] = LDQ( RSC_BOX_POWER_POLICY_9_CODE_EQ),
	[RSC_BOX_POWER_POLICY_10]= LDQ( RSC_BOX_POWER_POLICY_10_CODE_EQ),
	[RSC_BOX_POWER_POLICY_11]= LDQ( RSC_BOX_POWER_POLICY_11_CODE_EQ),
	[RSC_BOX_POWER_POLICY_12]= LDQ( RSC_BOX_POWER_POLICY_11_CODE_EQ),
	[RSC_BOX_POWER_POLICY_13]= LDQ( RSC_BOX_POWER_POLICY_13_CODE_EQ),
	[RSC_BOX_POWER_POLICY_14]= LDQ( RSC_BOX_POWER_POLICY_14_CODE_EQ),
	...
	[RSC_BOX_TDP_TITLE]	= LDQ(	RSC_BOX_TDP_TITLE_CODE_EQ),
	[RSC_BOX_TDP_BLANK]	= LDQ(	RSC_BOX_TDP_BLANK_CODE_EQ),
