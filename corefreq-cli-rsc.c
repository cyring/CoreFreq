...
ATTRIBUTE Rsc_CreateSelectRatio_Cond_Attr[2][35] = {
	RSC_CREATE_SELECT_RATIO_COND0_ATTR,
	RSC_CREATE_SELECT_RATIO_COND1_ATTR
};
...
[RSC_SYSINFO_PERFMON_HWP_CAP_COND1]=LDB(Rsc_SysInfoPerfMon_HWP_Cap_Attr[1]),
   ...
   [RSC_CREATE_HOTPLUG_CPU_DISABLE]=LDA(Rsc_CreateHotPlugCPU_Disable_Attr,
    ...
    [RSC_CREATE_SELECT_RATIO_COND0]=LDB(Rsc_CreateSelectRatio_Cond_Attr[0]),
    [RSC_CREATE_SELECT_RATIO_COND1]=LDB(Rsc_CreateSelectRatio_Cond_Attr[1]),
...
/* ASCII */
  ...
  [RSC_SETTINGS_CPUFREQ_REGISTERED]=LDT(RSC_SETTINGS_CPUFREQ_REGISTER_CODE_EN,
	...
	[RSC_SELECT_RATIO_TITLE]= LDT(	RSC_SELECT_RATIO_TITLE_CODE_EN,
					RSC_SELECT_RATIO_TITLE_CODE_FR),
