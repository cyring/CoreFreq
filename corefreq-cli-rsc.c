...
#define LDT(en_var, fr_var)	LDA(vColor, en_var, fr_var)
...
/* ATTRIBUTE */
    [RSC_RUN_STATE_COLOR]	= LDS(	Rsc_SymbolRunColor_Attr),
    [RSC_UNINT_STATE_COLOR]	= LDS(	Rsc_SymbolUnIntColor_Attr),
    [RSC_ZOMBIE_STATE_COLOR]	= LDS(	Rsc_SymbolZombieColor_Attr),
    [RSC_SLEEP_STATE_COLOR]	= LDS(	Rsc_SymbolSleepColor_Attr),
    [RSC_WAIT_STATE_COLOR]	= LDS(	Rsc_SymbolWaitColor_Attr),
    [RSC_OTHER_STATE_COLOR]	= LDS(	Rsc_SymbolOtherColor_Attr),
    [RSC_TRACKER_STATE_COLOR]	= LDS(	Rsc_SymbolTrackerColor_Attr),
    [RSC_SYSINFO_CPUID_COND0]	= LDS(	Rsc_SysInfoCPUID_Cond_Attr[0]),
    [RSC_SYSINFO_CPUID_COND1]	= LDS(	Rsc_SysInfoCPUID_Cond_Attr[1]),
    [RSC_SYSINFO_CPUID_COND2]	= LDS(	Rsc_SysInfoCPUID_Cond_Attr[2]),
    [RSC_SYSINFO_CPUID_COND3]	= LDS(	Rsc_SysInfoCPUID_Cond_Attr[3]),
    [RSC_SYSTEM_REGISTERS_COND0]= LDS(	Rsc_SystemRegisters_Cond_Attr[0]),
    [RSC_SYSTEM_REGISTERS_COND1]= LDS(	Rsc_SystemRegisters_Cond_Attr[1]),
    [RSC_SYSTEM_REGISTERS_COND2]= LDS(	Rsc_SystemRegisters_Cond_Attr[2]),
    [RSC_SYSINFO_PROC_COND0]	= LDS(	Rsc_SysInfoProc_Cond_Attr[0]),
    [RSC_SYSINFO_PROC_COND1]	= LDS(	Rsc_SysInfoProc_Cond_Attr[1]),
    [RSC_SYSINFO_PROC_COND2]	= LDS(	Rsc_SysInfoProc_Cond_Attr[2]),
    [RSC_SYSINFO_PROC_COND3]	= LDS(	Rsc_SysInfoProc_Cond_Attr[3]),
    [RSC_SYSINFO_ISA_COND_0_0]	= LDS(	Rsc_SysInfoISA_Cond_Attr[0][0]),
    [RSC_SYSINFO_ISA_COND_0_1]	= LDS(	Rsc_SysInfoISA_Cond_Attr[0][1]),
    [RSC_SYSINFO_ISA_COND_0_2]	= LDS(	Rsc_SysInfoISA_Cond_Attr[0][2]),
    [RSC_SYSINFO_ISA_COND_0_3]	= LDS(	Rsc_SysInfoISA_Cond_Attr[0][3]),
    [RSC_SYSINFO_ISA_COND_0_4]	= LDS(	Rsc_SysInfoISA_Cond_Attr[0][4]),
    [RSC_SYSINFO_ISA_COND_1_0]	= LDS(	Rsc_SysInfoISA_Cond_Attr[1][0]),
    [RSC_SYSINFO_ISA_COND_1_1]	= LDS(	Rsc_SysInfoISA_Cond_Attr[1][1]),
    [RSC_SYSINFO_ISA_COND_1_2]	= LDS(	Rsc_SysInfoISA_Cond_Attr[1][2]),
    [RSC_SYSINFO_ISA_COND_1_3]	= LDS(	Rsc_SysInfoISA_Cond_Attr[1][3]),
    [RSC_SYSINFO_ISA_COND_1_4]	= LDS(	Rsc_SysInfoISA_Cond_Attr[1][4]),
    [RSC_SYSINFO_ISA_COND_2_0]	= LDS(	Rsc_SysInfoISA_Cond_Attr[2][0]),
    [RSC_SYSINFO_ISA_COND_2_1]	= LDS(	Rsc_SysInfoISA_Cond_Attr[2][1]),
    [RSC_SYSINFO_ISA_COND_2_2]	= LDS(	Rsc_SysInfoISA_Cond_Attr[2][2]),
    [RSC_SYSINFO_ISA_COND_2_3]	= LDS(	Rsc_SysInfoISA_Cond_Attr[2][3]),
    [RSC_SYSINFO_ISA_COND_2_4]	= LDS(	Rsc_SysInfoISA_Cond_Attr[2][4]),
    [RSC_SYSINFO_ISA_COND_3_0]	= LDS(	Rsc_SysInfoISA_Cond_Attr[3][0]),
    [RSC_SYSINFO_ISA_COND_3_1]	= LDS(	Rsc_SysInfoISA_Cond_Attr[3][1]),
    [RSC_SYSINFO_ISA_COND_3_2]	= LDS(	Rsc_SysInfoISA_Cond_Attr[3][2]),
    [RSC_SYSINFO_ISA_COND_3_3]	= LDS(	Rsc_SysInfoISA_Cond_Attr[3][3]),
    [RSC_SYSINFO_ISA_COND_3_4]	= LDS(	Rsc_SysInfoISA_Cond_Attr[3][4]),
    [RSC_SYSINFO_FEATURES_COND0]= LDS(	Rsc_SysInfoFeatures_Cond_Attr[0]),
    [RSC_SYSINFO_FEATURES_COND1]= LDS(	Rsc_SysInfoFeatures_Cond_Attr[1]),
    [RSC_SYSINFO_FEATURES_COND2]= LDS(	Rsc_SysInfoFeatures_Cond_Attr[2]),
    [RSC_SYSINFO_TECH_COND0]	= LDS(	Rsc_SysInfoTech_Cond_Attr[0]),
    [RSC_SYSINFO_TECH_COND1]	= LDS(	Rsc_SysInfoTech_Cond_Attr[1]),
    [RSC_SYSINFO_PERFMON_COND0] = LDS(	Rsc_SysInfoPerfMon_Cond_Attr[0]),
    [RSC_SYSINFO_PERFMON_COND1] = LDS(	Rsc_SysInfoPerfMon_Cond_Attr[1]),
    [RSC_SYSINFO_PERFMON_COND2] = LDS(	Rsc_SysInfoPerfMon_Cond_Attr[2]),
    [RSC_SYSINFO_PERFMON_COND3] = LDS(	Rsc_SysInfoPerfMon_Cond_Attr[3]),
    [RSC_SYSINFO_PERFMON_COND4] = LDS(	Rsc_SysInfoPerfMon_Cond_Attr[4]),
[RSC_SYSINFO_PERFMON_HWP_CAP_COND0]=LDS(Rsc_SysInfoPerfMon_HWP_Cap_Attr[0]),
[RSC_SYSINFO_PERFMON_HWP_CAP_COND1]=LDS(Rsc_SysInfoPerfMon_HWP_Cap_Attr[1]),
    [RSC_SYSINFO_PWR_THERMAL_COND0]=LDS(Rsc_SysInfoPwrThermal_Cond_Attr[0]),
    [RSC_SYSINFO_PWR_THERMAL_COND1]=LDS(Rsc_SysInfoPwrThermal_Cond_Attr[1]),
    [RSC_SYSINFO_PWR_THERMAL_COND2]=LDS(Rsc_SysInfoPwrThermal_Cond_Attr[2]),
    [RSC_SYSINFO_PWR_THERMAL_COND3]=LDS(Rsc_SysInfoPwrThermal_Cond_Attr[3]),
    [RSC_SYSINFO_PWR_THERMAL_COND4]=LDS(Rsc_SysInfoPwrThermal_Cond_Attr[4]),
    [RSC_SYSINFO_KERNEL]	= LDS(	Rsc_SysInfoKernel_Attr),
    [RSC_TOPOLOGY_COND0]	= LDS(	Rsc_Topology_Cond_Attr[0]),
    [RSC_TOPOLOGY_COND1]	= LDS(	Rsc_Topology_Cond_Attr[1]),
    [RSC_TOPOLOGY_COND2]	= LDS(	Rsc_Topology_Cond_Attr[2]),
    [RSC_MEMORY_CONTROLLER_COND0]=LDS(	Rsc_MemoryController_Cond_Attr[0]),
    [RSC_MEMORY_CONTROLLER_COND1]=LDS(	Rsc_MemoryController_Cond_Attr[1]),
    [RSC_CREATE_MENU_DISABLE]	= LDS(	Rsc_CreateMenu_Disable_Attr),
    [RSC_CREATE_MENU_FN_KEY]	= LDS(	Rsc_CreateMenu_FnKey_Attr),
    [RSC_CREATE_MENU_SHORTKEY]	= LDS(	Rsc_CreateMenu_ShortKey_Attr),
    [RSC_CREATE_MENU_CTRL_KEY]	= LDS(	Rsc_CreateMenu_CtrlKey_Attr),
   ...
   [RSC_CREATE_HOTPLUG_CPU_DISABLE]=LDA(Rsc_CreateHotPlugCPU_Disable_Attr,
    ...
    [RSC_CREATE_RATIO_CLOCK_COND0]=LDS( Rsc_CreateRatioClock_Cond_Attr[0]),
    [RSC_CREATE_RATIO_CLOCK_COND1]=LDS( Rsc_CreateRatioClock_Cond_Attr[1]),
    [RSC_CREATE_RATIO_CLOCK_COND2]=LDS( Rsc_CreateRatioClock_Cond_Attr[2]),
    [RSC_CREATE_RATIO_CLOCK_COND3]=LDS( Rsc_CreateRatioClock_Cond_Attr[3]),
    [RSC_CREATE_SELECT_CPU_COND0] = LDS(Rsc_CreateSelectCPU_Cond_Attr[0]),
    [RSC_CREATE_SELECT_CPU_COND1] = LDS(Rsc_CreateSelectCPU_Cond_Attr[1]),
    [RSC_HOT_EVENT_COND0]	= LDS(	Rsc_HotEvent_Cond_Attr[0]),
    [RSC_HOT_EVENT_COND1]	= LDS(	Rsc_HotEvent_Cond_Attr[1]),
    [RSC_HOT_EVENT_COND2]	= LDS(	Rsc_HotEvent_Cond_Attr[2]),
    [RSC_HOT_EVENT_COND3]	= LDS(	Rsc_HotEvent_Cond_Attr[3]),
    [RSC_HOT_EVENT_COND4]	= LDS(	Rsc_HotEvent_Cond_Attr[4]),
	[RSC_BOX_EVENT] 	= LDS(	Rsc_BoxEvent_Attr),
	[RSC_CREATE_RECORDER]	= LDS(	Rsc_CreateRecorder_Attr),
	[RSC_SMBIOS_ITEM]	= LDS(	Rsc_SMBIOS_Item_Attr),
/* ASCII */
  ...
  [RSC_SETTINGS_CPUIDLE_REGISTERED]=LDT(RSC_SETTINGS_CPUIDLE_REGISTERED_CODE_EN,
					RSC_SETTINGS_CPUIDLE_REGISTERED_CODE_FR),
  [RSC_SETTINGS_CPUFREQ_REGISTERED]=LDT(RSC_SETTINGS_CPUFREQ_REGISTERED_CODE_EN,
					RSC_SETTINGS_CPUFREQ_REGISTERED_CODE_FR),
	...
	[RSC_HELP_BLANK]	= LDT(	Rsc_CreateHelp_Blank_Code,
	...
	[RSC_ADV_HELP_ITEM_1]	= LDT(	RSC_ADV_HELP_ITEM_1_CODE_EN,
					RSC_ADV_HELP_ITEM_1_CODE_FR),
	[RSC_ADV_HELP_ITEM_2]	= LDT(	RSC_ADV_HELP_ITEM_2_CODE_EN,
					RSC_ADV_HELP_ITEM_2_CODE_FR),
	[RSC_ADV_HELP_ITEM_3]	= LDT(	RSC_ADV_HELP_ITEM_3_CODE_EN,
					RSC_ADV_HELP_ITEM_3_CODE_FR),
	[RSC_ADV_HELP_ITEM_4]	= LDT(	RSC_ADV_HELP_ITEM_4_CODE_EN,
					RSC_ADV_HELP_ITEM_4_CODE_FR),
	[RSC_ADV_HELP_ITEM_5]	= LDT(	RSC_ADV_HELP_ITEM_5_CODE_EN,
					RSC_ADV_HELP_ITEM_5_CODE_FR),
	[RSC_ADV_HELP_ITEM_6]	= LDT(	RSC_ADV_HELP_ITEM_6_CODE_EN,
					RSC_ADV_HELP_ITEM_6_CODE_FR),
	[RSC_ADV_HELP_ITEM_7]	= LDT(	RSC_ADV_HELP_ITEM_7_CODE_EN,
					RSC_ADV_HELP_ITEM_7_CODE_FR),
	[RSC_ADV_HELP_ITEM_8]	= LDT(	RSC_ADV_HELP_ITEM_8_CODE_EN,
					RSC_ADV_HELP_ITEM_8_CODE_FR),
	[RSC_ADV_HELP_ITEM_9]	= LDT(	RSC_ADV_HELP_ITEM_9_CODE_EN,
					RSC_ADV_HELP_ITEM_9_CODE_FR),
	[RSC_ADV_HELP_ITEM_10]	= LDT(	RSC_ADV_HELP_ITEM_10_CODE_EN,
					RSC_ADV_HELP_ITEM_10_CODE_FR),
	[RSC_ADV_HELP_ITEM_11]	= LDT(	RSC_ADV_HELP_ITEM_11_CODE_EN,
					RSC_ADV_HELP_ITEM_11_CODE_FR),
	[RSC_ADV_HELP_ITEM_12]	= LDT(	RSC_ADV_HELP_ITEM_12_CODE_EN,
					RSC_ADV_HELP_ITEM_12_CODE_FR),
	[RSC_ADV_HELP_ITEM_13]	= LDT(	RSC_ADV_HELP_ITEM_13_CODE_EN,
					RSC_ADV_HELP_ITEM_13_CODE_FR),
	[RSC_ADV_HELP_ITEM_14]	= LDT(	RSC_ADV_HELP_ITEM_14_CODE_EN,
					RSC_ADV_HELP_ITEM_14_CODE_FR),
       [RSC_ADV_HELP_ITEM_TERMINAL]=LDT(RSC_ADV_HELP_ITEM_TERMINAL_CODE_EN,
					RSC_ADV_HELP_ITEM_TERMINAL_CODE_FR),
	[RSC_ADV_HELP_ITEM_PRT_SCR]=LDT(RSC_ADV_HELP_ITEM_PRT_SCR_CODE_EN,
					RSC_ADV_HELP_ITEM_PRT_SCR_CODE_FR),
	[RSC_ADV_HELP_ITEM_REC_SCR]=LDT(RSC_ADV_HELP_ITEM_REC_SCR_CODE_EN,
					RSC_ADV_HELP_ITEM_REC_SCR_CODE_FR),
      [RSC_ADV_HELP_ITEM_FAHR_CELS]=LDT(RSC_ADV_HELP_ITEM_FAHR_CELS_CODE_EN,
					RSC_ADV_HELP_ITEM_FAHR_CELS_CODE_FR),
     [RSC_ADV_HELP_ITEM_PROC_EVENT]=LDT(RSC_ADV_HELP_ITEM_PROC_EVENT_CODE_EN,
					RSC_ADV_HELP_ITEM_PROC_EVENT_CODE_FR),
	[RSC_ADV_HELP_ITEM_SECRET]= LDT(RSC_ADV_HELP_ITEM_SECRET_CODE_EN,
					RSC_ADV_HELP_ITEM_SECRET_CODE_FR),
    ...
    [RSC_BOX_EXPERIMENT_MODE_COND0]=LDT(RSC_BOX_EXPERIMENT_MODE_COND0_CODE_EN,
					RSC_BOX_EXPERIMENT_MODE_COND0_CODE_FR),
    [RSC_BOX_EXPERIMENT_MODE_COND1]=LDT(RSC_BOX_EXPERIMENT_MODE_COND1_CODE_EN,
					RSC_BOX_EXPERIMENT_MODE_COND1_CODE_FR),
	[RSC_BOX_INTERRUPT_TITLE]=LDT(	RSC_BOX_INTERRUPT_TITLE_CODE_EN,
					RSC_BOX_INTERRUPT_TITLE_CODE_FR),
    [RSC_BOX_INT_REGISTER_COND0]= LDT(	RSC_BOX_INT_REGISTER_COND0_CODE_EN,
					RSC_BOX_INT_REGISTER_COND0_CODE_FR),
    [RSC_BOX_INT_REGISTER_COND1]= LDT(	RSC_BOX_INT_REGISTER_COND1_CODE_EN,
					RSC_BOX_INT_REGISTER_COND1_CODE_FR),
    [RSC_BOX_INT_UNREGISTER_COND0]=LDT( RSC_BOX_INT_UNREGISTER_COND0_CODE_EN,
					RSC_BOX_INT_UNREGISTER_COND0_CODE_FR),
    [RSC_BOX_INT_UNREGISTER_COND1]=LDT( RSC_BOX_INT_UNREGISTER_COND1_CODE_EN,
					RSC_BOX_INT_UNREGISTER_COND1_CODE_FR),
  ...
  [RSC_BOX_EVENT_THERMAL_THRESHOLD]=LDT(RSC_BOX_EVENT_THERMAL_THRESHOLD_CODE_EN,
					RSC_BOX_EVENT_THERMAL_THRESHOLD_CODE_FR),
  [RSC_BOX_EVENT_POWER_LIMITATION]=LDT( RSC_BOX_EVENT_POWER_LIMITATION_CODE_EN,
					RSC_BOX_EVENT_POWER_LIMITATION_CODE_FR),
[RSC_BOX_EVENT_CURRENT_LIMITATION]=LDT(RSC_BOX_EVENT_CURRENT_LIMITATION_CODE_EN,
				       RSC_BOX_EVENT_CURRENT_LIMITATION_CODE_FR),
[RSC_BOX_EVENT_CROSS_DOMAIN_LIMIT]=LDT(RSC_BOX_EVENT_CROSS_DOMAIN_LIMIT_CODE_EN,
				       RSC_BOX_EVENT_CROSS_DOMAIN_LIMIT_CODE_FR),
[RSC_BOX_PACKAGE_STATE_LIMIT_TITLE]=LDT(RSC_BOX_PKG_STATE_TITLE_CODE_EN,
...
[RSC_BOX_EXTENDED_DUTY_CYCLE_TITLE]=LDT(RSC_BOX_EXT_DUTY_CYCLE_TITLE_CODE_EN,
