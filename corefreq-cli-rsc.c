...
ASCII	RSC_SYS_REGS_HDR_CPU_CODE_EQ[]	= RSC_SYS_REGS_HDR_CPU_CODE_EN,
	RSC_SYS_REG_HDR_FLAGS_CODE_EQ[] = RSC_SYS_REG_HDR_FLAGS_CODE_EN,
	RSC_SYS_REG_HDR_TF_CODE_EQ[]	= RSC_SYS_REG_HDR_TF_CODE_EN,
	RSC_SYS_REG_HDR_IF_CODE_EQ[]	= RSC_SYS_REG_HDR_IF_CODE_EN,
	RSC_SYS_REG_HDR_IOPL_CODE_EQ[]	= RSC_SYS_REG_HDR_IOPL_CODE_EN,
	RSC_SYS_REG_HDR_NT_CODE_EQ[]	= RSC_SYS_REG_HDR_NT_CODE_EN,
	RSC_SYS_REG_HDR_RF_CODE_EQ[]	= RSC_SYS_REG_HDR_RF_CODE_EN,
	RSC_SYS_REG_HDR_VM_CODE_EQ[]	= RSC_SYS_REG_HDR_VM_CODE_EN,
	RSC_SYS_REG_HDR_AC_CODE_EQ[]	= RSC_SYS_REG_HDR_AC_CODE_EN,
	RSC_SYS_REG_HDR_VIF_CODE_EQ[]	= RSC_SYS_REG_HDR_VIF_CODE_EN,
	RSC_SYS_REG_HDR_VIP_CODE_EQ[]	= RSC_SYS_REG_HDR_VIP_CODE_EN,
	RSC_SYS_REG_HDR_ID_CODE_EQ[]	= RSC_SYS_REG_HDR_ID_CODE_EN,
	RSC_SYS_REG_FLAGS_TF_CODE_EQ[]	= RSC_SYS_REG_FLAGS_TF_CODE_EN,
	RSC_SYS_REG_FLAGS_IF_CODE_EQ[]	= RSC_SYS_REG_FLAGS_IF_CODE_EN,
	RSC_SYS_REG_FLAGS_IOPL_CODE_EQ[]= RSC_SYS_REG_FLAGS_IOPL_CODE_EN,
	RSC_SYS_REG_FLAGS_NT_CODE_EQ[]	= RSC_SYS_REG_FLAGS_NT_CODE_EN,
	RSC_SYS_REG_FLAGS_RF_CODE_EQ[]	= RSC_SYS_REG_FLAGS_RF_CODE_EN,
	RSC_SYS_REG_FLAGS_VM_CODE_EQ[]	= RSC_SYS_REG_FLAGS_VM_CODE_EN,
	RSC_SYS_REG_FLAGS_AC_CODE_EQ[]	= RSC_SYS_REG_FLAGS_AC_CODE_EN,
	RSC_SYS_REG_FLAGS_VIF_CODE_EQ[] = RSC_SYS_REG_FLAGS_VIF_CODE_EN,
	RSC_SYS_REG_FLAGS_VIP_CODE_EQ[] = RSC_SYS_REG_FLAGS_VIP_CODE_EN,
	RSC_SYS_REG_FLAGS_ID_CODE_EQ[]	= RSC_SYS_REG_FLAGS_ID_CODE_EN,
	RSC_SYS_REG_HDR_CR0_CODE_EQ[]	= RSC_SYS_REG_HDR_CR0_CODE_EN,
	RSC_SYS_REG_HDR_CR0_PE_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_PE_CODE_EN,
	RSC_SYS_REG_HDR_CR0_MP_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_MP_CODE_EN,
	RSC_SYS_REG_HDR_CR0_EM_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_EM_CODE_EN,
	RSC_SYS_REG_HDR_CR0_TS_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_TS_CODE_EN,
	RSC_SYS_REG_HDR_CR0_ET_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_ET_CODE_EN,
	RSC_SYS_REG_HDR_CR0_NE_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_NE_CODE_EN,
	RSC_SYS_REG_HDR_CR0_WP_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_WP_CODE_EN,
	RSC_SYS_REG_HDR_CR0_AM_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_AM_CODE_EN,
	RSC_SYS_REG_HDR_CR0_NW_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_NW_CODE_EN,
	RSC_SYS_REG_HDR_CR0_CD_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_CD_CODE_EN,
	RSC_SYS_REG_HDR_CR0_PG_CODE_EQ[]= RSC_SYS_REG_HDR_CR0_PG_CODE_EN,
	RSC_SYS_REGS_CR0_CODE_EQ[]	= RSC_SYS_REGS_CR0_CODE_EN,
	RSC_SYS_REG_CR0_PE_CODE_EQ[]	= RSC_SYS_REG_CR0_PE_CODE_EN,
	RSC_SYS_REG_CR0_MP_CODE_EQ[]	= RSC_SYS_REG_CR0_MP_CODE_EN,
	RSC_SYS_REG_CR0_EM_CODE_EQ[]	= RSC_SYS_REG_CR0_EM_CODE_EN,
	RSC_SYS_REG_CR0_TS_CODE_EQ[]	= RSC_SYS_REG_CR0_TS_CODE_EN,
	RSC_SYS_REG_CR0_ET_CODE_EQ[]	= RSC_SYS_REG_CR0_ET_CODE_EN,
	RSC_SYS_REG_CR0_NE_CODE_EQ[]	= RSC_SYS_REG_CR0_NE_CODE_EN,
	RSC_SYS_REG_CR0_WP_CODE_EQ[]	= RSC_SYS_REG_CR0_WP_CODE_EN,
	RSC_SYS_REG_CR0_AM_CODE_EQ[]	= RSC_SYS_REG_CR0_AM_CODE_EN,
	RSC_SYS_REG_CR0_NW_CODE_EQ[]	= RSC_SYS_REG_CR0_NW_CODE_EN,
	RSC_SYS_REG_CR0_CD_CODE_EQ[]	= RSC_SYS_REG_CR0_CD_CODE_EN,
	RSC_SYS_REG_CR0_PG_CODE_EQ[]	= RSC_SYS_REG_CR0_PG_CODE_EN,
	RSC_SYS_REG_HDR_CR3_CODE_EQ[]	= RSC_SYS_REG_HDR_CR3_CODE_EN,
	RSC_SYS_REG_HDR_CR3_PWT_CODE_EQ[]=RSC_SYS_REG_HDR_CR3_PWT_CODE_EN,
	RSC_SYS_REG_HDR_CR3_PCD_CODE_EQ[]=RSC_SYS_REG_HDR_CR3_PCD_CODE_EN,
	RSC_SYS_REGS_CR3_CODE_EQ[]	= RSC_SYS_REGS_CR3_CODE_EN,
	RSC_SYS_REG_CR3_PWT_CODE_EQ[]	= RSC_SYS_REG_CR3_PWT_CODE_EN,
	RSC_SYS_REG_CR3_PCD_CODE_EQ[]	= RSC_SYS_REG_CR3_PCD_CODE_EN,
	RSC_SYS_REG_HDR_CR4_CODE_EQ[]	= RSC_SYS_REG_HDR_CR4_CODE_EN,
	RSC_SYS_REG_HDR_CR4_VME_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_VME_CODE_EN,
	RSC_SYS_REG_HDR_CR4_PVI_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_PVI_CODE_EN,
	RSC_SYS_REG_HDR_CR4_TSD_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_TSD_CODE_EN,
	RSC_SYS_REG_HDR_CR4_DE_CODE_EQ[]= RSC_SYS_REG_HDR_CR4_DE_CODE_EN,
	RSC_SYS_REG_HDR_CR4_PSE_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_PSE_CODE_EN,
	RSC_SYS_REG_HDR_CR4_PAE_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_PAE_CODE_EN,
	RSC_SYS_REG_HDR_CR4_MCE_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_MCE_CODE_EN,
	RSC_SYS_REG_HDR_CR4_PGE_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_PGE_CODE_EN,
	RSC_SYS_REG_HDR_CR4_PCE_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_PCE_CODE_EN,
	RSC_SYS_REG_HDR_CR4_FX_CODE_EQ[]= RSC_SYS_REG_HDR_CR4_FX_CODE_EN,
	RSC_SYS_REG_HDR_CR4_XMM_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_XMM_CODE_EN,
	RSC_SYS_REG_HDR_CR4_UMIP_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_UMIP_CODE_EN,
	RSC_SYS_REG_HDR_CR4_5LP_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_5LP_CODE_EN,
	RSC_SYS_REG_HDR_CR4_VMX_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_VMX_CODE_EN,
	RSC_SYS_REG_HDR_CR4_SMX_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_SMX_CODE_EN,
	RSC_SYS_REG_HDR_CR4_FS_CODE_EQ[]= RSC_SYS_REG_HDR_CR4_FS_CODE_EN,
	RSC_SYS_REG_HDR_CR4_PCID_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_PCID_CODE_EN,
	RSC_SYS_REG_HDR_CR4_SAV_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_SAV_CODE_EN,
	RSC_SYS_REG_HDR_CR4_KL_CODE_EQ[]= RSC_SYS_REG_HDR_CR4_KL_CODE_EN,
	RSC_SYS_REG_HDR_CR4_SME_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_SME_CODE_EN,
	RSC_SYS_REG_HDR_CR4_SMA_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_SMA_CODE_EN,
	RSC_SYS_REG_HDR_CR4_PKE_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_PKE_CODE_EN,
	RSC_SYS_REG_HDR_CR4_CET_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_CET_CODE_EN,
	RSC_SYS_REG_HDR_CR4_PKS_CODE_EQ[]=RSC_SYS_REG_HDR_CR4_PKS_CODE_EN,
	RSC_SYS_REGS_CR4_CODE_EQ[]	= RSC_SYS_REGS_CR4_CODE_EN,
	RSC_SYS_REG_CR4_VME_CODE_EQ[]	= RSC_SYS_REG_CR4_VME_CODE_EN,
	RSC_SYS_REG_CR4_PVI_CODE_EQ[]	= RSC_SYS_REG_CR4_PVI_CODE_EN,
	RSC_SYS_REG_CR4_TSD_CODE_EQ[]	= RSC_SYS_REG_CR4_TSD_CODE_EN,
	RSC_SYS_REG_CR4_DE_CODE_EQ[]	= RSC_SYS_REG_CR4_DE_CODE_EN,
	RSC_SYS_REG_CR4_PSE_CODE_EQ[]	= RSC_SYS_REG_CR4_PSE_CODE_EN,
	RSC_SYS_REG_CR4_PAE_CODE_EQ[]	= RSC_SYS_REG_CR4_PAE_CODE_EN,
	RSC_SYS_REG_CR4_MCE_CODE_EQ[]	= RSC_SYS_REG_CR4_MCE_CODE_EN,
	RSC_SYS_REG_CR4_PGE_CODE_EQ[]	= RSC_SYS_REG_CR4_PGE_CODE_EN,
	RSC_SYS_REG_CR4_PCE_CODE_EQ[]	= RSC_SYS_REG_CR4_PCE_CODE_EN,
	RSC_SYS_REG_CR4_FX_CODE_EQ[]	= RSC_SYS_REG_CR4_FX_CODE_EN,
	RSC_SYS_REG_CR4_XMM_CODE_EQ[]	= RSC_SYS_REG_CR4_XMM_CODE_EN,
	RSC_SYS_REG_CR4_UMIP_CODE_EQ[]	= RSC_SYS_REG_CR4_UMIP_CODE_EN,
	RSC_SYS_REG_CR4_5LP_CODE_EQ[]	= RSC_SYS_REG_CR4_5LP_CODE_EN,
	RSC_SYS_REG_CR4_VMX_CODE_EQ[]	= RSC_SYS_REG_CR4_VMX_CODE_EN,
	RSC_SYS_REG_CR4_SMX_CODE_EQ[]	= RSC_SYS_REG_CR4_SMX_CODE_EN,
	RSC_SYS_REG_CR4_FS_CODE_EQ[]	= RSC_SYS_REG_CR4_FS_CODE_EN,
	RSC_SYS_REG_CR4_PCID_CODE_EQ[]	= RSC_SYS_REG_CR4_PCID_CODE_EN,
	RSC_SYS_REG_CR4_SAV_CODE_EQ[]	= RSC_SYS_REG_CR4_SAV_CODE_EN,
	RSC_SYS_REG_CR4_KL_CODE_EQ[]	= RSC_SYS_REG_CR4_KL_CODE_EN,
	RSC_SYS_REG_CR4_SME_CODE_EQ[]	= RSC_SYS_REG_CR4_SME_CODE_EN,
	RSC_SYS_REG_CR4_SMA_CODE_EQ[]	= RSC_SYS_REG_CR4_SMA_CODE_EN,
	RSC_SYS_REG_CR4_PKE_CODE_EQ[]	= RSC_SYS_REG_CR4_PKE_CODE_EN,
	RSC_SYS_REG_CR4_CET_CODE_EQ[]	= RSC_SYS_REG_CR4_CET_CODE_EN,
	RSC_SYS_REG_CR4_PKS_CODE_EQ[]	= RSC_SYS_REG_CR4_PKS_CODE_EN,
	RSC_SYS_REG_HDR_CR8_CODE_EQ[]	= RSC_SYS_REG_HDR_CR8_CODE_EN,
	RSC_SYS_REG_HDR_CR8_TPL_CODE_EQ[]=RSC_SYS_REG_HDR_CR8_TPL_CODE_EN,
	RSC_SYS_REGS_CR8_CODE_EQ[]	= RSC_SYS_REGS_CR8_CODE_EN,
	RSC_SYS_REG_CR8_TPL_CODE_EQ[]	= RSC_SYS_REG_CR8_TPL_CODE_EN,
	RSC_SYS_REG_HDR_EFCR_CODE_EQ[]	= RSC_SYS_REG_HDR_EFCR_CODE_EN,
	RSC_SYS_REG_HDR_EFCR_LCK_CODE_EQ[]=RSC_SYS_REG_HDR_EFCR_LCK_CODE_EN,
	RSC_SYS_REG_HDR_EFCR_VMX_CODE_EQ[]=RSC_SYS_REG_HDR_EFCR_VMX_CODE_EN,
	RSC_SYS_REG_HDR_EFCR_SGX_CODE_EQ[]=RSC_SYS_REG_HDR_EFCR_SGX_CODE_EN,
	RSC_SYS_REG_HDR_EFCR_LSE_CODE_EQ[]=RSC_SYS_REG_HDR_EFCR_LSE_CODE_EN,
	RSC_SYS_REG_HDR_EFCR_GSE_CODE_EQ[]=RSC_SYS_REG_HDR_EFCR_GSE_CODE_EN,
	RSC_SYS_REG_HDR_EFCR_LSGX_CODE_EQ[]=RSC_SYS_REG_HDR_EFCR_LSGX_CODE_EN,
	RSC_SYS_REG_HDR_EFCR_GSGX_CODE_EQ[]=RSC_SYS_REG_HDR_EFCR_GSGX_CODE_EN,
	RSC_SYS_REG_HDR_EFCR_LMC_CODE_EQ[]=RSC_SYS_REG_HDR_EFCR_LMC_CODE_EN,
	RSC_SYS_REGS_EFCR_CODE_EQ[]	= RSC_SYS_REGS_EFCR_CODE_EN,
	RSC_SYS_REG_EFCR_LCK_CODE_EQ[]	= RSC_SYS_REG_EFCR_LCK_CODE_EN,
	RSC_SYS_REG_EFCR_VMX_CODE_EQ[]	= RSC_SYS_REG_EFCR_VMX_CODE_EN,
	RSC_SYS_REG_EFCR_SGX_CODE_EQ[]	= RSC_SYS_REG_EFCR_SGX_CODE_EN,
	RSC_SYS_REG_EFCR_LSE_CODE_EQ[]	= RSC_SYS_REG_EFCR_LSE_CODE_EN,
	RSC_SYS_REG_EFCR_GSE_CODE_EQ[]	= RSC_SYS_REG_EFCR_GSE_CODE_EN,
	RSC_SYS_REG_EFCR_LSGX_CODE_EQ[] = RSC_SYS_REG_EFCR_LSGX_CODE_EN,
	RSC_SYS_REG_EFCR_GSGX_CODE_EQ[] = RSC_SYS_REG_EFCR_GSGX_CODE_EN,
	RSC_SYS_REG_EFCR_LMC_CODE_EQ[]	= RSC_SYS_REG_EFCR_LMC_CODE_EN,
	RSC_SYS_REG_HDR_EFER_CODE_EQ[]	= RSC_SYS_REG_HDR_EFER_CODE_EN,
	RSC_SYS_REG_HDR_EFER_SCE_CODE_EQ[]=RSC_SYS_REG_HDR_EFER_SCE_CODE_EN,
	RSC_SYS_REG_HDR_EFER_LME_CODE_EQ[]=RSC_SYS_REG_HDR_EFER_LME_CODE_EN,
	RSC_SYS_REG_HDR_EFER_LMA_CODE_EQ[]=RSC_SYS_REG_HDR_EFER_LMA_CODE_EN,
	RSC_SYS_REG_HDR_EFER_NXE_CODE_EQ[]=RSC_SYS_REG_HDR_EFER_NXE_CODE_EN,
	RSC_SYS_REG_HDR_EFER_SVM_CODE_EQ[]=RSC_SYS_REG_HDR_EFER_SVM_CODE_EN,
	RSC_SYS_REGS_EFER_CODE_EQ[]	= RSC_SYS_REGS_EFER_CODE_EN,
	RSC_SYS_REG_EFER_SCE_CODE_EQ[]	= RSC_SYS_REG_EFER_SCE_CODE_EN,
	RSC_SYS_REG_EFER_LME_CODE_EQ[]	= RSC_SYS_REG_EFER_LME_CODE_EN,
	RSC_SYS_REG_EFER_LMA_CODE_EQ[]	= RSC_SYS_REG_EFER_LMA_CODE_EN,
	RSC_SYS_REG_EFER_NXE_CODE_EQ[]	= RSC_SYS_REG_EFER_NXE_CODE_EN,
	RSC_SYS_REG_EFER_SVM_CODE_EQ[]	= RSC_SYS_REG_EFER_SVM_CODE_EN;
...
{									\
	...
	.Size = {							\
		[LOC_EN] = sizeof(eq_var) - 1,				\
		[LOC_FR] = sizeof(eq_var) - 1				\
	}								\
}
...
/* ASCII */
	...
	[RSC_SYS_REGS_SPACE]	= LDT(	RSC_SYS_REGS_SPACE_CODE_EN,
					RSC_SYS_REGS_SPACE_CODE_EN),
	[RSC_SYS_REGS_NA]	= LDT(	RSC_SYS_REGS_NA_CODE_EN,
					RSC_SYS_REGS_NA_CODE_EN),
	[RSC_SYS_REGS_HDR_CPU]	= LDQ(	RSC_SYS_REGS_HDR_CPU_CODE_EQ),
	[RSC_SYS_REG_HDR_FLAGS] = LDQ(	RSC_SYS_REG_HDR_FLAGS_CODE_EQ),
	[RSC_SYS_REG_HDR_TF]	= LDQ(	RSC_SYS_REG_HDR_TF_CODE_EQ),
	[RSC_SYS_REG_HDR_IF]	= LDQ(	RSC_SYS_REG_HDR_IF_CODE_EQ),
	[RSC_SYS_REG_HDR_IOPL]	= LDQ(	RSC_SYS_REG_HDR_IOPL_CODE_EQ),
	[RSC_SYS_REG_HDR_NT]	= LDQ(	RSC_SYS_REG_HDR_NT_CODE_EQ),
	[RSC_SYS_REG_HDR_RF]	= LDQ(	RSC_SYS_REG_HDR_RF_CODE_EQ),
	[RSC_SYS_REG_HDR_VM]	= LDQ(	RSC_SYS_REG_HDR_VM_CODE_EN),
	[RSC_SYS_REG_HDR_AC]	= LDQ(	RSC_SYS_REG_HDR_AC_CODE_EQ),
	[RSC_SYS_REG_HDR_VIF]	= LDQ(	RSC_SYS_REG_HDR_VIF_CODE_EQ),
	[RSC_SYS_REG_HDR_VIP]	= LDQ(	RSC_SYS_REG_HDR_VIP_CODE_EQ),
	[RSC_SYS_REG_HDR_ID]	= LDQ(	RSC_SYS_REG_HDR_ID_CODE_EQ),
	[RSC_SYS_REG_FLAGS_TF]	= LDQ(	RSC_SYS_REG_FLAGS_TF_CODE_EQ),
	[RSC_SYS_REG_FLAGS_IF]	= LDQ(	RSC_SYS_REG_FLAGS_IF_CODE_EQ),
	[RSC_SYS_REG_FLAGS_IOPL]= LDQ(	RSC_SYS_REG_FLAGS_IOPL_CODE_EQ),
	[RSC_SYS_REG_FLAGS_NT]	= LDQ(	RSC_SYS_REG_FLAGS_NT_CODE_EQ),
	[RSC_SYS_REG_FLAGS_RF]	= LDQ(	RSC_SYS_REG_FLAGS_RF_CODE_EQ),
	[RSC_SYS_REG_FLAGS_VM]	= LDQ(	RSC_SYS_REG_FLAGS_VM_CODE_EQ),
	[RSC_SYS_REG_FLAGS_AC]	= LDQ(	RSC_SYS_REG_FLAGS_AC_CODE_EQ),
	[RSC_SYS_REG_FLAGS_VIF] = LDQ(	RSC_SYS_REG_FLAGS_VIF_CODE_EQ),
	[RSC_SYS_REG_FLAGS_VIP] = LDQ(	RSC_SYS_REG_FLAGS_VIP_CODE_EQ),
	[RSC_SYS_REG_FLAGS_ID]	= LDQ(	RSC_SYS_REG_FLAGS_ID_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0]	= LDQ(	RSC_SYS_REG_HDR_CR0_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_PE] = LDQ( RSC_SYS_REG_HDR_CR0_PE_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_MP] = LDQ( RSC_SYS_REG_HDR_CR0_MP_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_EM] = LDQ( RSC_SYS_REG_HDR_CR0_EM_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_TS] = LDQ( RSC_SYS_REG_HDR_CR0_TS_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_ET] = LDQ( RSC_SYS_REG_HDR_CR0_ET_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_NE] = LDQ( RSC_SYS_REG_HDR_CR0_NE_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_WP] = LDQ( RSC_SYS_REG_HDR_CR0_WP_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_AM] = LDQ( RSC_SYS_REG_HDR_CR0_AM_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_NW] = LDQ( RSC_SYS_REG_HDR_CR0_NW_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_CD] = LDQ( RSC_SYS_REG_HDR_CR0_CD_CODE_EQ),
	[RSC_SYS_REG_HDR_CR0_PG] = LDQ( RSC_SYS_REG_HDR_CR0_PG_CODE_EQ),
	[RSC_SYS_REGS_CR0]	= LDQ(	RSC_SYS_REGS_CR0_CODE_EQ),
	[RSC_SYS_REG_CR0_PE]	= LDQ(	RSC_SYS_REG_CR0_PE_CODE_EQ),
	[RSC_SYS_REG_CR0_MP]	= LDQ(	RSC_SYS_REG_CR0_MP_CODE_EQ),
	[RSC_SYS_REG_CR0_EM]	= LDQ(	RSC_SYS_REG_CR0_EM_CODE_EQ),
	[RSC_SYS_REG_CR0_TS]	= LDQ(	RSC_SYS_REG_CR0_TS_CODE_EQ),
	[RSC_SYS_REG_CR0_ET]	= LDQ(	RSC_SYS_REG_CR0_ET_CODE_EQ),
	[RSC_SYS_REG_CR0_NE]	= LDQ(	RSC_SYS_REG_CR0_NE_CODE_EQ),
	[RSC_SYS_REG_CR0_WP]	= LDQ(	RSC_SYS_REG_CR0_WP_CODE_EQ),
	[RSC_SYS_REG_CR0_AM]	= LDQ(	RSC_SYS_REG_CR0_AM_CODE_EQ),
	[RSC_SYS_REG_CR0_NW]	= LDQ(	RSC_SYS_REG_CR0_NW_CODE_EQ),
	[RSC_SYS_REG_CR0_CD]	= LDQ(	RSC_SYS_REG_CR0_CD_CODE_EQ),
	[RSC_SYS_REG_CR0_PG]	= LDQ(	RSC_SYS_REG_CR0_PG_CODE_EQ),
	[RSC_SYS_REG_HDR_CR3]	= LDQ(	RSC_SYS_REG_HDR_CR3_CODE_EQ),
	[RSC_SYS_REG_HDR_CR3_PWT] = LDQ(RSC_SYS_REG_HDR_CR3_PWT_CODE_EQ),
	[RSC_SYS_REG_HDR_CR3_PCD] = LDQ(RSC_SYS_REG_HDR_CR3_PCD_CODE_EQ),
	[RSC_SYS_REGS_CR3]	= LDQ(	RSC_SYS_REGS_CR3_CODE_EQ),
	[RSC_SYS_REG_CR3_PWT]	= LDQ(	RSC_SYS_REG_CR3_PWT_CODE_EQ),
	[RSC_SYS_REG_CR3_PCD]	= LDQ(	RSC_SYS_REG_CR3_PCD_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4]	= LDQ(	RSC_SYS_REG_HDR_CR4_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_VME] = LDQ(RSC_SYS_REG_HDR_CR4_VME_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_PVI] = LDQ(RSC_SYS_REG_HDR_CR4_PVI_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_TSD] = LDQ(RSC_SYS_REG_HDR_CR4_TSD_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_DE] = LDQ( RSC_SYS_REG_HDR_CR4_DE_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_PSE] = LDQ(RSC_SYS_REG_HDR_CR4_PSE_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_PAE] = LDQ(RSC_SYS_REG_HDR_CR4_PAE_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_MCE] = LDQ(RSC_SYS_REG_HDR_CR4_MCE_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_PGE] = LDQ(RSC_SYS_REG_HDR_CR4_PGE_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_PCE] = LDQ(RSC_SYS_REG_HDR_CR4_PCE_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_FX] = LDQ( RSC_SYS_REG_HDR_CR4_FX_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_XMM] = LDQ(RSC_SYS_REG_HDR_CR4_XMM_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_UMIP]= LDQ(RSC_SYS_REG_HDR_CR4_UMIP_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_5LP] = LDQ(RSC_SYS_REG_HDR_CR4_5LP_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_VMX] = LDQ(RSC_SYS_REG_HDR_CR4_VMX_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_SMX] = LDQ(RSC_SYS_REG_HDR_CR4_SMX_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_FS] = LDQ( RSC_SYS_REG_HDR_CR4_FS_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_PCID]= LDQ(RSC_SYS_REG_HDR_CR4_PCID_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_SAV] = LDQ(RSC_SYS_REG_HDR_CR4_SAV_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_KL] = LDQ( RSC_SYS_REG_HDR_CR4_KL_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_SME] = LDQ(RSC_SYS_REG_HDR_CR4_SME_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_SMA] = LDQ(RSC_SYS_REG_HDR_CR4_SMA_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_PKE] = LDQ(RSC_SYS_REG_HDR_CR4_PKE_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_CET] = LDQ(RSC_SYS_REG_HDR_CR4_CET_CODE_EQ),
	[RSC_SYS_REG_HDR_CR4_PKS] = LDQ(RSC_SYS_REG_HDR_CR4_PKS_CODE_EQ),
	[RSC_SYS_REGS_CR4]	= LDQ(	RSC_SYS_REGS_CR4_CODE_EQ),
	[RSC_SYS_REG_CR4_VME]	= LDQ(	RSC_SYS_REG_CR4_VME_CODE_EQ),
	[RSC_SYS_REG_CR4_PVI]	= LDQ(	RSC_SYS_REG_CR4_PVI_CODE_EQ),
	[RSC_SYS_REG_CR4_TSD]	= LDQ(	RSC_SYS_REG_CR4_TSD_CODE_EQ),
	[RSC_SYS_REG_CR4_DE]	= LDQ(	RSC_SYS_REG_CR4_DE_CODE_EQ),
	[RSC_SYS_REG_CR4_PSE]	= LDQ(	RSC_SYS_REG_CR4_PSE_CODE_EQ),
	[RSC_SYS_REG_CR4_PAE]	= LDQ(	RSC_SYS_REG_CR4_PAE_CODE_EQ),
	[RSC_SYS_REG_CR4_MCE]	= LDQ(	RSC_SYS_REG_CR4_MCE_CODE_EQ),
	[RSC_SYS_REG_CR4_PGE]	= LDQ(	RSC_SYS_REG_CR4_PGE_CODE_EQ),
	[RSC_SYS_REG_CR4_PCE]	= LDQ(	RSC_SYS_REG_CR4_PCE_CODE_EQ),
	[RSC_SYS_REG_CR4_FX]	= LDQ(	RSC_SYS_REG_CR4_FX_CODE_EQ),
	[RSC_SYS_REG_CR4_XMM]	= LDQ(	RSC_SYS_REG_CR4_XMM_CODE_EQ),
	[RSC_SYS_REG_CR4_UMIP]	= LDQ(	RSC_SYS_REG_CR4_UMIP_CODE_EQ),
	[RSC_SYS_REG_CR4_5LP]	= LDQ(	RSC_SYS_REG_CR4_5LP_CODE_EQ),
	[RSC_SYS_REG_CR4_VMX]	= LDQ(	RSC_SYS_REG_CR4_VMX_CODE_EQ),
	[RSC_SYS_REG_CR4_SMX]	= LDQ(	RSC_SYS_REG_CR4_SMX_CODE_EQ),
	[RSC_SYS_REG_CR4_FS]	= LDQ(	RSC_SYS_REG_CR4_FS_CODE_EQ),
	[RSC_SYS_REG_CR4_PCID]	= LDQ(	RSC_SYS_REG_CR4_PCID_CODE_EQ),
	[RSC_SYS_REG_CR4_SAV]	= LDQ(	RSC_SYS_REG_CR4_SAV_CODE_EQ),
	[RSC_SYS_REG_CR4_KL]	= LDQ(	RSC_SYS_REG_CR4_KL_CODE_EQ),
	[RSC_SYS_REG_CR4_SME]	= LDQ(	RSC_SYS_REG_CR4_SME_CODE_EQ),
	[RSC_SYS_REG_CR4_SMA]	= LDQ(	RSC_SYS_REG_CR4_SMA_CODE_EQ),
	[RSC_SYS_REG_CR4_PKE]	= LDQ(	RSC_SYS_REG_CR4_PKE_CODE_EQ),
	[RSC_SYS_REG_CR4_CET]	= LDQ(	RSC_SYS_REG_CR4_CET_CODE_EQ),
	[RSC_SYS_REG_CR4_PKS]	= LDQ(	RSC_SYS_REG_CR4_PKS_CODE_EQ),
	[RSC_SYS_REG_HDR_CR8]	= LDQ(	RSC_SYS_REG_HDR_CR8_CODE_EQ),
	[RSC_SYS_REG_HDR_CR8_TPL] = LDQ(RSC_SYS_REG_HDR_CR8_TPL_CODE_EQ),
	[RSC_SYS_REGS_CR8]	= LDQ(	RSC_SYS_REGS_CR8_CODE_EQ),
	[RSC_SYS_REG_CR8_TPL]	= LDQ(	RSC_SYS_REG_CR8_TPL_CODE_EQ),
	[RSC_SYS_REG_HDR_EFCR]	= LDQ(	RSC_SYS_REG_HDR_EFCR_CODE_EQ),
	[RSC_SYS_REG_HDR_EFCR_LCK]= LDQ(RSC_SYS_REG_HDR_EFCR_LCK_CODE_EQ),
	[RSC_SYS_REG_HDR_EFCR_VMX]= LDQ(RSC_SYS_REG_HDR_EFCR_VMX_CODE_EQ),
	[RSC_SYS_REG_HDR_EFCR_SGX]= LDQ(RSC_SYS_REG_HDR_EFCR_SGX_CODE_EQ),
	[RSC_SYS_REG_HDR_EFCR_LSE]= LDQ(RSC_SYS_REG_HDR_EFCR_LSE_CODE_EQ),
	[RSC_SYS_REG_HDR_EFCR_GSE]= LDQ(RSC_SYS_REG_HDR_EFCR_GSE_CODE_EQ),
	[RSC_SYS_REG_HDR_EFCR_LSGX]=LDQ(RSC_SYS_REG_HDR_EFCR_LSGX_CODE_EQ),
	[RSC_SYS_REG_HDR_EFCR_GSGX]=LDQ(RSC_SYS_REG_HDR_EFCR_GSGX_CODE_EQ),
	[RSC_SYS_REG_HDR_EFCR_LMC]= LDQ(RSC_SYS_REG_HDR_EFCR_LMC_CODE_EQ),
	[RSC_SYS_REGS_EFCR]	= LDQ(	RSC_SYS_REGS_EFCR_CODE_EQ),
	[RSC_SYS_REG_EFCR_LCK]	= LDQ(	RSC_SYS_REG_EFCR_LCK_CODE_EQ),
	[RSC_SYS_REG_EFCR_VMX]	= LDQ(	RSC_SYS_REG_EFCR_VMX_CODE_EQ),
	[RSC_SYS_REG_EFCR_SGX]	= LDQ(	RSC_SYS_REG_EFCR_SGX_CODE_EQ),
	[RSC_SYS_REG_EFCR_LSE]	= LDQ(	RSC_SYS_REG_EFCR_LSE_CODE_EQ),
	[RSC_SYS_REG_EFCR_GSE]	= LDQ(	RSC_SYS_REG_EFCR_GSE_CODE_EQ),
	[RSC_SYS_REG_EFCR_LSGX] = LDQ(	RSC_SYS_REG_EFCR_LSGX_CODE_EQ),
	[RSC_SYS_REG_EFCR_GSGX] = LDQ(	RSC_SYS_REG_EFCR_GSGX_CODE_EQ),
	[RSC_SYS_REG_EFCR_LMC]	= LDQ(	RSC_SYS_REG_EFCR_LMC_CODE_EQ),
	[RSC_SYS_REG_HDR_EFER]	= LDQ(	RSC_SYS_REG_HDR_EFER_CODE_EQ),
	[RSC_SYS_REG_HDR_EFER_SCE]= LDQ(RSC_SYS_REG_HDR_EFER_SCE_CODE_EQ),
	[RSC_SYS_REG_HDR_EFER_LME]= LDQ(RSC_SYS_REG_HDR_EFER_LME_CODE_EQ),
	[RSC_SYS_REG_HDR_EFER_LMA]= LDQ(RSC_SYS_REG_HDR_EFER_LMA_CODE_EQ),
	[RSC_SYS_REG_HDR_EFER_NXE]= LDQ(RSC_SYS_REG_HDR_EFER_NXE_CODE_EQ),
	[RSC_SYS_REG_HDR_EFER_SVM]= LDQ(RSC_SYS_REG_HDR_EFER_SVM_CODE_EQ),
	[RSC_SYS_REGS_EFER]	= LDQ(	RSC_SYS_REGS_EFER_CODE_EQ),
	[RSC_SYS_REG_EFER_SCE]	= LDQ(	RSC_SYS_REG_EFER_SCE_CODE_EQ),
	[RSC_SYS_REG_EFER_LME]	= LDQ(	RSC_SYS_REG_EFER_LME_CODE_EQ),
	[RSC_SYS_REG_EFER_LMA]	= LDQ(	RSC_SYS_REG_EFER_LMA_CODE_EQ),
	[RSC_SYS_REG_EFER_NXE]	= LDQ(	RSC_SYS_REG_EFER_NXE_CODE_EQ),
	[RSC_SYS_REG_EFER_SVM]	= LDQ(	RSC_SYS_REG_EFER_SVM_CODE_EQ),
 ...
 [RSC_SETTINGS_GOVERNOR_REGISTERED]=LDT(RSC_SETTINGS_GOVERNOR_CPUFREQ_CODE_EN,
    ...
    [RSC_BOX_OPS_UNREGISTER_COND0]=LDT( RSC_BOX_OPS_UNREGISTER_ST0_CODE_EN,
					RSC_BOX_OPS_UNREGISTER_ST0_CODE_FR),
    [RSC_BOX_OPS_UNREGISTER_COND1]=LDT( RSC_BOX_OPS_UNREGISTER_ST1_CODE_EN,
					RSC_BOX_OPS_UNREGISTER_ST1_CODE_FR),
