...
DEF_LDB(RSC_BOX_EVENT_COND0);
DEF_LDB(RSC_BOX_EVENT_COND1);
DEF_LDB(RSC_BOX_EVENT_COND2);
DEF_LDB(RSC_BOX_EVENT_COND3);
...
#endif
	LDB(RSC_BOX_EVENT_COND0),
	LDB(RSC_BOX_EVENT_COND1),
	LDB(RSC_BOX_EVENT_COND2),
	LDB(RSC_BOX_EVENT_COND3),
