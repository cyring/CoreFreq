...
/* ASCII */
 ...
 [RSC_SETTINGS_GOVERNOR_REGISTERED]=LDT(RSC_SETTINGS_GOVERNOR_CPUFREQ_CODE_EN,
	...
	[RSC_BOX_TDP_TITLE]	= LDQ(	RSC_BOX_TDP_TITLE_CODE),
	[RSC_BOX_TDP_BLANK]	= LDQ(	RSC_BOX_TDP_BLANK_CODE),
	[RSC_BOX_TDP_LVL0]	= LDT(	RSC_BOX_TDP_LVL0_CODE_EN,
					RSC_BOX_TDP_LVL0_CODE_FR),
	[RSC_BOX_TDP_LVL1]	= LDT(	RSC_BOX_TDP_LVL1_CODE_EN,
					RSC_BOX_TDP_LVL1_CODE_FR),
	[RSC_BOX_TDP_LVL2]	= LDT(	RSC_BOX_TDP_LVL2_CODE_EN,
					RSC_BOX_TDP_LVL2_CODE_FR),
