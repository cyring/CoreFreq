...
/* ASCII */
	...
	[RSC_TECHNOLOGIES_WDT]	= LDT(	RSC_TECHNOLOGIES_WDT_CODE_EN,
					RSC_TECHNOLOGIES_WDT_CODE_FR),
 ...
 [RSC_SETTINGS_GOVERNOR_REGISTERED]=LDT(RSC_SETTINGS_GOVERNOR_CPUFREQ_CODE_EN,
	...
	[RSC_BOX_WDT_TITLE]	= LDQ(	RSC_BOX_WDT_TITLE_CODE),
	[RSC_BOX_WDT_DESC]	= LDT(	RSC_BOX_WDT_DESC_CODE_EN,
					RSC_BOX_WDT_DESC_CODE_FR),
