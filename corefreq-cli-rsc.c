...
/* ASCII */
 ...
 [RSC_SETTINGS_GOVERNOR_REGISTERED]=LDT(RSC_SETTINGS_GOVERNOR_CPUFREQ_CODE_EN,
	...
	[RSC_BOX_AMP_OFFSET0]	= LDQ(	RSC_BOX_AMP_OFFSET0_CODE),
	[RSC_BOX_AMP_OFFSET1]	= LDQ(	RSC_BOX_AMP_OFFSET1_CODE),
	[RSC_BOX_AMP_OFFSET2]	= LDQ(	RSC_BOX_AMP_OFFSET2_CODE),
	[RSC_BOX_AMP_OFFSET3]	= LDQ(	RSC_BOX_AMP_OFFSET3_CODE),
	[RSC_BOX_AMP_OFFSET4]	= LDQ(	RSC_BOX_AMP_OFFSET4_CODE),
	[RSC_BOX_AMP_OFFSET5]	= LDQ(	RSC_BOX_AMP_OFFSET5_CODE),
	[RSC_BOX_AMP_OFFSET6]	= LDQ(	RSC_BOX_AMP_OFFSET6_CODE),
	[RSC_BOX_AMP_OFFSET7]	= LDQ(	RSC_BOX_AMP_OFFSET7_CODE),
