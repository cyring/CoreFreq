...
#define BOXKEY_PLX_OP		0x3000000000021200
#define BOXKEY_PL1_OR		(BOXKEY_PLX_OP | (0x8 << PL1))
#define BOXKEY_PL2_OR		(BOXKEY_PLX_OP | (0x8 << PL2))

#define BOXKEY_TDP_MASK 	0x0000000000000007
#define BOXKEY_PLX_MASK 	0x0000000000000018
...
#define BOXKEY_ROUTE_MASK	0x00000000000000f0
...
enum {
	...
	OPS_IDLE_ROUTE		= 0x1000000000008100,
  ...
  BOXKEY_L2_HW_CL_PREFETCH_ON	= 0x3000000000004242,
	...
	BOXKEY_WDT		= 0x3000000000004400,
	BOXKEY_WDT_OFF		= 0x3000000000004401,
	BOXKEY_WDT_ON		= 0x3000000000004402,
	...
	BOXKEY_THEME_DFLT	= 0x3000000000014081,
	BOXKEY_THEME_USR1	= 0x3000000000014082,
	BOXKEY_THEME_USR2	= 0x3000000000014083,
