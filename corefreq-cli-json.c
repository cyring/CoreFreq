        ...
        json_key(&s, "Features");
        {
            ...
            json_key(&s, "MWait");
            {
                ...
                json_key(&s, "EDX");
                {
                    ...
                    json_key(&s, "ReservedBits");
                    json_literal(&s, "%u", (unsigned) Shm->Proc.Features.MWait.EDX.ReservedBits);
            ...
            json_key(&s, "ExtFeature");
            {
                ...
                json_key(&s, "EBX");
                {
                    ...
                    json_key(&s, "Unused1");
                    json_literal(&s, "%u", (unsigned) Shm->Proc.Features.ExtFeature.EBX.Unused1);
                    json_key(&s, "SMEP");
                    ...
                    json_key(&s, "Unused3");
                    json_literal(&s, "%u", (unsigned) Shm->Proc.Features.ExtFeature.EBX.Unused3);
                    json_key(&s, "ProcessorTrace");
                    json_literal(&s, "%u", (unsigned) Shm->Proc.Features.ExtFeature.EBX.ProcessorTrace);
                    json_key(&s, "Unused4");
                    json_literal(&s, "%u", (unsigned) Shm->Proc.Features.ExtFeature.EBX.Unused4);
                ...
                json_key(&s, "ECX");
                {
                    ...
                    json_key(&s, "Unused1");
                    json_literal(&s, "%u", (unsigned) Shm->Proc.Features.ExtFeature.ECX.Unused1);
                    json_key(&s, "PKU");
                    ...
                    json_key(&s, "Unused2");
                    json_literal(&s, "%u", (unsigned) Shm->Proc.Features.ExtFeature.ECX.Unused2);
            ...
            json_key(&s, "PerfMon");
            {
                ...
                json_key(&s, "EDX");
                {
                    ...
                    json_key(&s, "Unused1");
                    json_literal(&s, "%u", (unsigned) Shm->Proc.Features.PerfMon.EDX.Unused1);
                    json_end_object(&s);
                }
