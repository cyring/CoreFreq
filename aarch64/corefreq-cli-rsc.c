...
/* ASCII */
	...
	LDT(RSC_TECHNOLOGIES_ICN),
	LDT(RSC_TECHNOLOGIES_DYNAMIQ),
	LDT(RSC_TECHNOLOGIES_CMN),
	LDT(RSC_TECHNOLOGIES_CCN),
	LDT(RSC_TECHNOLOGIES_CCI),
	LDQ(RSC_TECH_HYPERV_NONE),
	LDQ(RSC_TECH_BARE_METAL),
	LDQ(RSC_TECH_HYPERV_XEN),
	LDQ(RSC_TECH_HYPERV_KVM),
	LDQ(RSC_TECH_HYPERV_AVF),
	LDQ(RSC_TECH_HYPERV_VBOX),
	LDQ(RSC_TECH_HYPERV_KBOX),
	LDQ(RSC_TECH_HYPERV_VMWARE),
	LDQ(RSC_TECH_HYPERV_HYPERV),
	LDQ(RSC_TECH_DSU_NONE),
	LDQ(RSC_TECH_DSU_100),
	LDQ(RSC_TECH_DSU_AE),
	LDQ(RSC_TECH_DSU_110),
	LDQ(RSC_TECH_DSU_120),
	LDQ(RSC_TECH_DSU_120AE),
	LDQ(RSC_TECH_CMN_NONE),
	LDQ(RSC_TECH_CMN_600),
	LDQ(RSC_TECH_CMN_650),
	LDQ(RSC_TECH_CMN_700),
	LDQ(RSC_TECH_CMN_S3),
	LDQ(RSC_TECH_CMN_CI700),
	LDQ(RSC_TECH_CCN_NONE),
	LDQ(RSC_TECH_CCN_502),
	LDQ(RSC_TECH_CCN_504),
	LDQ(RSC_TECH_CCN_508),
	LDQ(RSC_TECH_CCN_512),
	LDQ(RSC_TECH_CCI_NONE),
	LDQ(RSC_TECH_CCI_400),
	LDQ(RSC_TECH_CCI_500),
	LDQ(RSC_TECH_CCI_550),
	...
	LDQ(RSC_PERF_LABEL_PMU),
	LDQ(RSC_PERF_LABEL_AMU),
