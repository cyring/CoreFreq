...
/* ASCII */
	...
	LDQ(RSC_SYS_REG_HDR_N),
	LDQ(RSC_SYS_REG_HDR_Z),
	LDQ(RSC_SYS_REG_HDR_C),
	LDQ(RSC_SYS_REG_HDR_V),
	LDQ(RSC_SYS_REG_HDR_D),
	LDQ(RSC_SYS_REG_HDR_A),
	LDQ(RSC_SYS_REG_HDR_I),
	LDQ(RSC_SYS_REG_HDR_F),
	LDQ(RSC_SYS_REG_HDR_L),
	LDQ(RSC_SYS_REG_HDR_M),
	LDT(RSC_SYS_REG_FLAGS_N),
	LDT(RSC_SYS_REG_FLAGS_Z),
	LDT(RSC_SYS_REG_FLAGS_C),
	LDT(RSC_SYS_REG_FLAGS_V),
	LDT(RSC_SYS_REG_FLAGS_D),
	LDT(RSC_SYS_REG_FLAGS_A),
	LDT(RSC_SYS_REG_FLAGS_I),
	LDT(RSC_SYS_REG_FLAGS_F),
	LDT(RSC_SYS_REG_FLAGS_L),
	LDT(RSC_SYS_REG_FLAGS_M),
	LDQ(RSC_SYS_REG_HDR_SCTL),
	LDT(RSC_SYS_REG_SCTL),
	LDQ(RSC_SYS_REG_HDR_SCTL2),
