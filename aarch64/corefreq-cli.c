				...
				unsigned int *cellPadding )
{
	...
	[ 1] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[ 0], NULL},
	[ 2] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[ 5],RSC(SYS_REG_FLAGS_N).CODE()},
	[ 3] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[10],RSC(SYS_REG_FLAGS_Z).CODE()},
	[ 4] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[15],RSC(SYS_REG_FLAGS_C).CODE()},
	[ 5] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[20],RSC(SYS_REG_FLAGS_V).CODE()},
	[ 6] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[25],RSC(SYS_REG_FLAGS_D).CODE()},
	[ 7] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[30],RSC(SYS_REG_FLAGS_A).CODE()},
	[ 8] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[35],RSC(SYS_REG_FLAGS_I).CODE()},
	[ 9] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[40],RSC(SYS_REG_FLAGS_F).CODE()},
	[10] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[45],RSC(SYS_REG_FLAGS_L).CODE()},
	[11] = {&RSC(SYS_REG_HDR_FLAGS).CODE()[50],RSC(SYS_REG_FLAGS_M).CODE()},
	...
	[ 1] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[ 5], NULL},
	[ 2] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[10], NULL},
	[ 3] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[15], NULL},
	[ 4] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[20], NULL},
	[ 5] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[25], NULL},
	[ 6] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[30], NULL},
	[ 7] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[35], NULL},
	[ 8] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[40], NULL},
	[ 9] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[45], NULL},
	[10] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[50], NULL},
	[11] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[55], NULL},
	[12] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[60], NULL},
	[13] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[65], NULL},
	[14] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[70], NULL},
	[15] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[75], NULL},
	[16] =	{&RSC(SYS_REG_HDR11_SCTL).CODE()[80], NULL},

	[17] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[ 0], RSC(SYS_REG_SCTL).CODE()},
	[18] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[ 5], NULL},
	[19] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[10], NULL},
	[20] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[15], NULL},
	[21] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[20], NULL},
	[22] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[25], NULL},
	[23] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[30], NULL},
	[24] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[35], NULL},
	[25] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[40], NULL},
	[26] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[45], NULL},
	[27] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[50], NULL},
	[28] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[55], NULL},
	[29] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[60], NULL},
	[30] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[65], NULL},
	[31] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[70], NULL},
	[32] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[75], NULL},
	[33] =	{&RSC(SYS_REG_HDR12_SCTL).CODE()[80], NULL},
		{NULL, NULL}
	},
	.flag = (struct SR_BIT[]) {
	[ 0] =	{DO_CPU , 1	, UNDEF_CR	, 0	},
	[ 1] =	{DO_SCTLR,1	, SCTLR_TIDCP	, 1	},
	[ 2] =	{DO_SCTLR,1	, SCTLR_SPINTMASK,1	},
	[ 3] =	{DO_SCTLR,1	, SCTLR_NMI	, 1	},
	[ 4] =	{DO_SCTLR,1	, SCTLR_EnTP2	, 1	},
	[ 5] =	{DO_SCTLR,1	, SCTLR_TCSO	, 1	},
	...
	[11] =	{DO_SCTLR,1	, SCTLR_TME	, 1	},
	[12] =	{DO_SCTLR,1	, SCTLR_TME0	, 1	},
	[13] =	{DO_SCTLR,1	, SCTLR_TMT	, 1	},
	...
	[ 1] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[ 5], NULL},
	[ 2] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[10], NULL},
	[ 3] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[15], NULL},
	[ 4] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[20], NULL},
	[ 5] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[25], NULL},
	[ 6] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[30], NULL},
	[ 7] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[35], NULL},
	[ 8] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[40], NULL},
	[ 9] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[45], NULL},
	[10] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[50], NULL},
	[11] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[55], NULL},
	[12] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[60], NULL},
	[13] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[65], NULL},
	[14] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[70], NULL},
	[15] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[75], NULL},
	[16] =	{&RSC(SYS_REG_HDR21_SCTL).CODE()[80], NULL},

	[17] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[ 0], RSC(SYS_REG_SCTL).CODE()},
	[18] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[ 5], NULL},
	[19] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[10], NULL},
	[20] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[15], NULL},
	[21] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[20], NULL},
	[22] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[25], NULL},
	[23] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[30], NULL},
	[24] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[35], NULL},
	[25] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[40], NULL},
	[26] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[45], NULL},
	[27] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[50], NULL},
	[28] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[55], NULL},
	[29] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[60], NULL},
	[30] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[65], NULL},
	[31] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[70], NULL},
	[32] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[75], NULL},
	[33] =	{&RSC(SYS_REG_HDR22_SCTL).CODE()[80], NULL},
		{NULL, NULL}
	},
	.flag = (struct SR_BIT[]) {
	[ 0] =	{DO_CPU , 1	, UNDEF_CR	, 0	},
	[ 1] =	{DO_SCTLR,1	, SCTLR_DSSBS	, 1	},
	[ 2] =	{DO_SCTLR,1	, SCTLR_ATA	, 1	},
	[ 3] =	{DO_SCTLR,1	, SCTLR_ATA0	, 1	},
	[ 4] =	{DO_SCTLR,1	, SCTLR_TCF	, 2	},
	...
	[ 1] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[ 5], NULL},
	[ 2] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[10], NULL},
	[ 3] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[15], NULL},
	[ 4] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[20], NULL},
	[ 5] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[25], NULL},
	[ 6] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[30], NULL},
	[ 7] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[35], NULL},
	[ 8] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[40], NULL},
	[ 9] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[45], NULL},
	[10] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[50], NULL},
	[11] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[55], NULL},
	[12] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[60], NULL},
	[13] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[65], NULL},
	[14] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[70], NULL},
	[15] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[75], NULL},
	[16] =	{&RSC(SYS_REG_HDR31_SCTL).CODE()[80], NULL},
		{NULL, NULL}
	},
	.flag = (struct SR_BIT[]) {
	[ 0] =	{DO_CPU , 1	, UNDEF_CR	, 0	},
	...
	[ 1] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[ 5], NULL},
	[ 2] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[10], NULL},
	[ 3] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[15], NULL},
	[ 4] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[20], NULL},
	[ 5] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[25], NULL},
	[ 6] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[30], NULL},
	[ 7] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[35], NULL},
	[ 8] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[40], NULL},
	[ 9] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[45], NULL},
	[10] =	{&RSC(SYS_REG_HDR41_SCTL).CODE()[50], NULL},
	...
	[ 5] =	{DO_SCTLR,1	, SCTLR_CP15BEN	, 1	},
	[ 6] =	{DO_SCTLR,1	, SCTLR_SA0	, 1	},
	[ 7] =	{DO_SCTLR,1	, SCTLR_SA	, 1	},
	...
	[ 1] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[ 5], NULL},
	[ 2] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[10], NULL},
	[ 3] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[15], NULL},
	[ 4] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[20], NULL},
	[ 5] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[25], NULL},
	[ 6] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[30], NULL},
	[ 7] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[35], NULL},
	[ 8] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[40], NULL},
	[ 9] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[45], NULL},
	[10] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[50], NULL},
	[11] =	{&RSC(SYS_REG_HDR11_SCTL2).CODE()[55], NULL},
	[12] =	{RSC(SYS_REGS_SPACE).CODE(),	NULL},
	[13] =	{RSC(SYS_REGS_SPACE).CODE(),	NULL},
	[14] =	{RSC(SYS_REGS_SPACE).CODE(),	NULL},
	[15] =	{RSC(SYS_REGS_SPACE).CODE(),	NULL},
	...
	[18] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[ 5], NULL},
	[19] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[10], NULL},
	[20] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[15], NULL},
	[21] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[20], NULL},
	[22] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[25], NULL},
	[23] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[30], NULL},
	[24] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[35], NULL},
	[25] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[40], NULL},
	[26] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[45], NULL},
	[27] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[50], NULL},
	[28] = {&RSC(SYS_REG_HDR12_SCTL2).CODE()[55], NULL},
	...
	[ 2] =	{DO_SCTLR2,1	, SCTLR2_CPTM	, 1	},
	[ 3] =	{DO_SCTLR2,1	, SCTLR2_CPTA0	, 1	},
	[ 4] =	{DO_SCTLR2,1	, SCTLR2_CPTA	, 1	},
	[ 5] =	{DO_SCTLR2,1	, SCTLR2_EnPACM0, 1	},
	[ 6] =	{DO_SCTLR2,1	, SCTLR2_EnPACM	, 1	},
...
/* Section Mark */
	bix = (RO(Shm)->Proc.Features.PerfMon.CoreCycles == 0)
	   || (RO(Shm)->Proc.Features.PerfMon.VectorSz > 0) ? 2 : 0;

	PUT(	SCANKEY_NULL, attrib[bix], width, 2,
		"%s%.*s[%7s]", RSC(PERF_MON_CORE_CYCLE).CODE(),
		width - 12 - RSZ(PERF_MON_CORE_CYCLE), hSpace, POWERED(bix) );

	bix = (RO(Shm)->Proc.Features.PerfMon.InstrRetired == 0)
	   || (RO(Shm)->Proc.Features.PerfMon.VectorSz >= 1) ? 2 : 0;

	PUT(	SCANKEY_NULL, attrib[bix], width, 2,
		"%s%.*s[%7s]", RSC(PERF_MON_INST_RET).CODE(),
		width - 12 - RSZ(PERF_MON_INST_RET), hSpace, POWERED(bix) );

	bix = (RO(Shm)->Proc.Features.PerfMon.RefCycles == 0)
	   || (RO(Shm)->Proc.Features.PerfMon.VectorSz >= 2) ? 2 : 0;

	PUT(	SCANKEY_NULL, attrib[bix], width, 2,
		"%s%.*s[%7s]", RSC(PERF_MON_REF_CYCLE).CODE(),
		width - 12 - RSZ(PERF_MON_REF_CYCLE), hSpace, POWERED(bix) );

	bix = (RO(Shm)->Proc.Features.PerfMon.LLC_Ref == 0)
	   || (RO(Shm)->Proc.Features.PerfMon.VectorSz >= 3) ? 2 : 0;
