				...
				unsigned int *cellPadding )
{
	...
	[ 7]={&RSC(SYS_REG_HDR_FLAGS).CODE()[30],RSC(SYS_REG_FLAGS_DIT).CODE()},
	[ 8]={&RSC(SYS_REG_HDR_FLAGS).CODE()[35],RSC(SYS_REG_FLAGS_A).CODE()},
	[ 9]={&RSC(SYS_REG_HDR_FLAGS).CODE()[40],RSC(SYS_REG_FLAGS_I).CODE()},
	[10]={&RSC(SYS_REG_HDR_FLAGS).CODE()[45],RSC(SYS_REG_FLAGS_F).CODE()},
	[11]={&RSC(SYS_REG_HDR_FLAGS).CODE()[50],RSC(SYS_REG_FLAGS_L).CODE()},
	[12]={&RSC(SYS_REG_HDR_FLAGS).CODE()[55],RSC(SYS_REG_FLAGS_M).CODE()},
	...
	[ 8] =	{DO_FLAG, 1	, FLAG_A	, 1	},
	[ 9] =	{DO_FLAG, 1	, FLAG_I	, 1	},
	[10] =	{DO_FLAG, 1	, FLAG_F	, 1	},
	[11] =	{DO_FLAG, 1	, FLAG_L	, 2	},
	[12] =	{DO_FLAG, 1	, FLAG_M	, 2	},
