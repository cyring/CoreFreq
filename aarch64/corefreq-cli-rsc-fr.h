...
#define RSC_SYS_REG_FLAGS_D_CODE_FR	RSC_SYS_REG_FLAGS_D_CODE_EN
#define RSC_SYS_REG_FLAGS_A_CODE_FR	RSC_SYS_REG_FLAGS_A_CODE_EN
#define RSC_SYS_REG_FLAGS_I_CODE_FR	RSC_SYS_REG_FLAGS_I_CODE_EN
