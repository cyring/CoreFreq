...
{
	double freeRAM_gigabytes = freeRAM / pow(1024, 2);
	double totalRAM_gigabytes = totalRAM / pow(1024, 2);
	
	sprintf(buffer, "%6u" "%9.3g" "%-9.3g", taskCount, freeRAM_gigabytes, totalRAM_gigabytes);
